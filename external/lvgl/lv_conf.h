...
#else       /*LV_MEM_CUSTOM*/
#define LV_MEM_CUSTOM_INCLUDE <user_memory.h>   /*Header for the dynamic memory function*/
...
#define LV_FS_STDIO_PATH "./ui_simulator"         /*Set the working directory. File/directory paths will be appended to it.*/
