...
void lv_keyboard_def_event_cb(lv_event_t * e)
{
    ...
    if (strcmp(txt, "abc") == 0) {
        ...
        return;
               ...
               strcmp(txt, USR_SYMBOL_ENTER) == 0 ||
               strcmp(txt, USR_SYMBOL_ARROW_NEXT) == 0 ||
               strcmp(txt, USR_SYMBOL_KB_NEXT) == 0 ||
               strcmp(txt, USR_SYMBOL_CHECK) == 0) {
        ...
        return;
    } else if (strcmp(txt, USR_SYMBOL_UPPER) == 0) {
        if (oldkeyMode == KEY_STONE_FULL_L) {
            keyMode = KEY_STONE_FULL_U;
        } else {
            keyMode = KEY_STONE_FULL_L;
        }
        oldkeyMode = keyMode;
    ...
    if (strcmp(txt, "Enter") == 0 || strcmp(txt, LV_SYMBOL_NEW_LINE) == 0) {
        ...
        lv_textarea_cursor_right(keyboard->ta);
               ...
               strcmp(txt, USR_SYMBOL_DELETE) == 0) {
        lv_textarea_del_char(keyboard->ta);
        lv_event_send(keyboard->ta, LV_EVENT_CANCEL, NULL);
    } else if (strcmp(txt, USR_SYMBOL_SPACE) == 0) {
        lv_textarea_add_char(keyboard->ta, ' ');
    } else if (strcmp(txt, "+/-") == 0) {
        ...
        lv_event_send(keyboard->ta, LV_EVENT_CLICKED, NULL);
    }
}
