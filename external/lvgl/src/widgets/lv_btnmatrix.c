...
static void draw_main(lv_event_t * e)
{
    ...
    for (btn_i = 0; btn_i < btnm->btn_cnt; btn_i++, txt_i++) {
        ...
        char idBuf[4] = {0};
        sprintf(idBuf, "%d", 1);
        lv_draw_label(draw_ctx, &draw_label_dsc_act, &btn_area, idBuf, NULL);
        btn_area.y1 += 20;
        btn_area.y2 += 20;
#endif
...
// stonewang
// static bool button_is_custom1(lv_btnmatrix_ctrl_t ctrl_bits)
// {
//     return (ctrl_bits & LV_BTNMATRIX_CTRL_CUSTOM_1) ? true : false;
// }
/**
