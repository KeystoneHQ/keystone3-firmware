...
//    lv_coord_t bg_leftp = lv_obj_get_style_pad_left(obj, LV_PART_MAIN) + bg_border;
    lv_coord_t bg_rightp = lv_obj_get_style_pad_right(obj, LV_PART_MAIN) + bg_border;
    lv_coord_t bg_colp = lv_obj_get_style_pad_column(obj, LV_PART_MAIN);
    ...
    marker_area.x1 = obj->coords.x2 - font_h - bg_rightp - marker_leftp - marker_rightp + 1;
    marker_area.x2 = obj->coords.x2 - bg_rightp;
    ...
    lv_area_t txt_area;
    txt_area.x1 = obj->coords.x1 + bg_colp;
