...
typedef enum {
    KEY_STONE_FULL_L = LV_KEYBOARD_MODE_USER_1,
    KEY_STONE_FULL_U,
    KEY_STONE_SYMBOL,
    KEY_STONE_LETTER,
    KEY_STONE_MNEMONIC_12,
    KEY_STONE_MNEMONIC_18,
    KEY_STONE_MNEMONIC_20,
    KEY_STONE_MNEMONIC_24,
    KEY_STONE_MNEMONIC_33,
} lv_keyboard_user_mode_t ;
