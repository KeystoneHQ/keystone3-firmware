...
impl MoveValue {
    pub fn simple_deserialize(blob: &[u8], ty: &MoveTypeLayout) -> crate::errors::Result<Self> {
...
impl MoveStruct {
    ...
    pub fn simple_deserialize(blob: &[u8], ty: &MoveStructLayout) -> crate::errors::Result<Self> {
        Ok(bcs::from_bytes_seed(ty, blob)?)
    }
...
impl TryInto<TypeTag> for &MoveTypeLayout {
    ...
    fn try_into(self) -> crate::errors::Result<TypeTag> {
        Ok(match self {
...
impl TryInto<StructTag> for &MoveStructLayout {
    ...
    fn try_into(self) -> crate::errors::Result<StructTag> {
