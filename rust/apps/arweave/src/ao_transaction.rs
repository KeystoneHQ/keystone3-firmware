...
mod tests {
    ...
    fn test_transform_ao_transfer() {
        ...
        assert_eq!(ao_transfer.from, "nSkowCiV4VBZJVyI2UK2wT_6g9LVX5BLZvYSTjd0bVQ");
        assert_eq!(ao_transfer.to, "qfz4BteboqMUoNSltEpw9KTdbf76fRRDfgx8Ai6DGJw");
        assert_eq!(ao_transfer.quantity, "10000000000");
        assert_eq!(ao_transfer.token_id, "xU9zFkq3X2ZQ6olwNVvr1vUWIjc3kXTWr7xKQD6dh10");
    }
}