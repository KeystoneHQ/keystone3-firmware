...
mod tests {
    ...
    #[test]
    fn test_parse_thorchain_send_direct() {
        let raw_tx = hex::decode("").unwrap();
        let result = ParsedCosmosTx::build(&raw_tx, DataType::Direct).unwrap();
        let overview = result.overview;
        assert_eq!("THORChain", overview.common.network);
    }
