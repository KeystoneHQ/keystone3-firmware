...
mod tests {
    ...
    fn test_parse_tx() {
        ...
        assert_eq!("0.002483224658432064", result.max_fee.unwrap());
        assert_eq!("0.0000158472", result.max_priority.unwrap());
        assert_eq!("158472", result.gas_limit);
        assert_eq!("0.002483224658432064", result.max_txn_fee);
