...
impl Network {
    ...
    pub fn from_hash(hash: &[u8]) -> Network {
        match hex::encode(hash).as_str() {
            ...
            "a3a1c6a78286713e29be0e9785670fa838d13917cd8eaeb4a3579ff1debc7fd5" => Network::Futurenet,
            "9a8931194023c5a25b7006a217b0ea590c5eaea9f6c61a356989899bbcf478bc" => Network::Sandbox,
            "baefd734b8d3e48472cff83912375fedbc7573701912fe308af730180f97d74a" => Network::Standalone,
            _ => Network::Public,
        }
    }
}
