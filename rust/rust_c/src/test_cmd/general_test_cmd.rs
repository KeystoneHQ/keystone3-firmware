...
#[no_mangle]
pub unsafe extern "C" fn test_get_ltc_keystone_bytes() -> *mut URParseResult {
...
#[no_mangle]
pub unsafe extern "C" fn test_get_dash_keystone_bytes() -> *mut URParseResult {
...
#[no_mangle]
pub unsafe extern "C" fn test_get_bch_keystone_bytes() -> *mut URParseResult {
...
#[no_mangle]
pub unsafe extern "C" fn test_get_tron_keystone_bytes() -> *mut URParseResult {
...
#[no_mangle]
pub unsafe extern "C" fn test_get_sol_sign_request(cbor: *mut c_char) -> *mut URParseResult {
...
#[no_mangle]
pub unsafe extern "C" fn test_get_sol_sign_message(cbor: *mut c_char) -> *mut URParseResult {
    let cbor_str = recover_c_char(cbor);
...
#[no_mangle]
pub unsafe extern "C" fn test_get_sui_sign_request(cbor: *mut c_char) -> *mut URParseResult {
    let cbor_str = recover_c_char(cbor);
...
#[no_mangle]
pub unsafe extern "C" fn test_get_aptos_sign_request(cbor: *mut c_char) -> *mut URParseResult {
    let cbor_str = recover_c_char(cbor);
...
#[no_mangle]
pub unsafe extern "C" fn test_get_cardano_sign_request() -> *mut URParseResult {
...
#[no_mangle]
pub unsafe extern "C" fn test_get_xrp_sign_request() -> *mut URParseResult {
...
#[no_mangle]
pub unsafe extern "C" fn test_get_xrp_parse_request(cbor: *mut c_char) -> *mut URParseResult {
    let cbor_str = recover_c_char(cbor);
...
#[no_mangle]
pub unsafe extern "C" fn test_get_cosmos_sign_request(cbor: *mut c_char) -> *mut URParseResult {
    let cbor_str = recover_c_char(cbor);
...
#[no_mangle]
pub unsafe extern "C" fn test_get_cosmos_evm_sign_request(cbor: *mut c_char) -> *mut URParseResult {
    let cbor_str = recover_c_char(cbor);
