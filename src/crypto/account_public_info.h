...
typedef enum {
    ...
    XPUB_TYPE_APT_8,
    XPUB_TYPE_APT_9,
    XPUB_TYPE_NEAR_BIP44_STANDARD_0,
    XPUB_TYPE_NEAR_LEDGER_LIVE_0,
    XPUB_TYPE_NEAR_LEDGER_LIVE_1,
    XPUB_TYPE_NEAR_LEDGER_LIVE_2,
    XPUB_TYPE_NEAR_LEDGER_LIVE_3,
    XPUB_TYPE_NEAR_LEDGER_LIVE_4,
    XPUB_TYPE_NEAR_LEDGER_LIVE_5,
    XPUB_TYPE_NEAR_LEDGER_LIVE_6,
    XPUB_TYPE_NEAR_LEDGER_LIVE_7,
    XPUB_TYPE_NEAR_LEDGER_LIVE_8,
    XPUB_TYPE_NEAR_LEDGER_LIVE_9,
    XPUB_TYPE_ADA_0,
    XPUB_TYPE_ADA_1,
    XPUB_TYPE_ADA_2,
    XPUB_TYPE_ADA_3,
