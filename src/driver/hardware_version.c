...
HardwareVersion GetHardwareVersion(void)
{
    ...
    if (version == VERSION_NONE) {
        ...
        if (adcValue < 1000) {
            version = VERSION_V3_2;//   adc : 1112
            printf("hardware version:VERSION 3.2\r\n");
        } else if (adcValue < 1500) {
            version = VERSION_V3_1;//   adc : 1112
            printf("hardware version:VERSION 3.1\r\n");
        } else if (adcValue < 2000) {
            version = VERSION_V3_0;//   adc : 1874
            printf("hardware version:VERSION 3.0\r\n");
