...
GetContSizeFunc GetAdaContainerSize(char *type)
{
    ...
    if (!strcmp(type, "GetCatalystVoteKeysPathSize")) {
        return GetCatalystVoteKeysPathSize;
    }
    return NULL;
}
#endif
...
GetLabelDataFunc GuiAdaTextFuncGet(char *type)
{
    ...
    } else if (!strcmp(type, "GetCatalystVoteKeysPath")) {
        return GetCatalystVoteKeysPath;
    }
    return NULL;
}
