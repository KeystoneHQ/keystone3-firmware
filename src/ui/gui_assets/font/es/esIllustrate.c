...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    /* U+00CD "Í" */
    0x0, 0xf0, 0xb, 0x0, 0x70, 0x0, 0x0, 0x0,
    0x0, 0xff, 0xc0, 0xb8, 0x2, 0xd0, 0xb, 0x40,
    0x2d, 0x0, 0xb4, 0x2, 0xd0, 0xb, 0x40, 0x2d,
    0x0, 0xb4, 0x2, 0xd0, 0xb, 0x40, 0x2e, 0x3,
    0xff, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3029, .adv_w = 86, .box_w = 3, .box_h = 15, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 3041, .adv_w = 183, .box_w = 11, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3080, .adv_w = 183, .box_w = 12, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3122, .adv_w = 86, .box_w = 3, .box_h = 3, .ofs_x = 1, .ofs_y = 6},
    {.bitmap_index = 3125, .adv_w = 139, .box_w = 9, .box_h = 15, .ofs_x = 0, .ofs_y = -4},
    {.bitmap_index = 3159, .adv_w = 204, .box_w = 13, .box_h = 19, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3221, .adv_w = 178, .box_w = 9, .box_h = 19, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3264, .adv_w = 108, .box_w = 7, .box_h = 19, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3298, .adv_w = 243, .box_w = 13, .box_h = 19, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3360, .adv_w = 180, .box_w = 10, .box_h = 15, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3398, .adv_w = 180, .box_w = 10, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3436, .adv_w = 83, .box_w = 5, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3455, .adv_w = 198, .box_w = 10, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3493, .adv_w = 194, .box_w = 11, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3535, .adv_w = 198, .box_w = 10, .box_h = 15, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3573, .adv_w = 183, .box_w = 12, .box_h = 14, .ofs_x = 0, .ofs_y = 0}
};
...
static const uint16_t unicode_list_2[] = {
    0x0, 0x2, 0x4, 0x16, 0x1e, 0x20, 0x28, 0x2c,
    0x30, 0x40, 0x48, 0x4c, 0x50, 0x52, 0x59, 0x200b
};
...
static const lv_font_fmt_txt_cmap_t cmaps[] =
{
    ...
    {
        .range_start = 161, .range_length = 8204, .glyph_id_start = 95,
