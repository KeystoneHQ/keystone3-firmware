 ...
 * Size: 36 px
 * Bpp: 1
 * Opts: --bpp 1 --size 36 --no-compress --font NotoSans-Regular.ttf --symbols "#%/0123456789ABCDEFIKLMNOPRSUVabcdefghijlmnoprstuvwyzéñó  --format lvgl -o ../gui_assets/font/es/esTitle.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1114, .adv_w = 195, .box_w = 9, .box_h = 26, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1144, .adv_w = 357, .box_w = 19, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1206, .adv_w = 302, .box_w = 15, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1255, .adv_w = 522, .box_w = 26, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1340, .adv_w = 438, .box_w = 20, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1405, .adv_w = 450, .box_w = 24, .box_h = 26, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1483, .adv_w = 348, .box_w = 16, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1535, .adv_w = 358, .box_w = 18, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1594, .adv_w = 316, .box_w = 17, .box_h = 26, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1650, .adv_w = 421, .box_w = 20, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1715, .adv_w = 346, .box_w = 22, .box_h = 26, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1787, .adv_w = 323, .box_w = 16, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1827, .adv_w = 354, .box_w = 17, .box_h = 27, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 1885, .adv_w = 276, .box_w = 14, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1920, .adv_w = 354, .box_w = 17, .box_h = 27, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1978, .adv_w = 325, .box_w = 16, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2018, .adv_w = 198, .box_w = 13, .box_h = 28, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2064, .adv_w = 354, .box_w = 17, .box_h = 29, .ofs_x = 2, .ofs_y = -9},
    {.bitmap_index = 2126, .adv_w = 356, .box_w = 16, .box_h = 27, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2180, .adv_w = 149, .box_w = 3, .box_h = 27, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2191, .adv_w = 149, .box_w = 8, .box_h = 36, .ofs_x = -2, .ofs_y = -9},
    {.bitmap_index = 2227, .adv_w = 149, .box_w = 3, .box_h = 27, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2238, .adv_w = 539, .box_w = 27, .box_h = 20, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2306, .adv_w = 356, .box_w = 16, .box_h = 20, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2346, .adv_w = 348, .box_w = 18, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2391, .adv_w = 354, .box_w = 17, .box_h = 29, .ofs_x = 3, .ofs_y = -9},
    {.bitmap_index = 2453, .adv_w = 238, .box_w = 11, .box_h = 20, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2481, .adv_w = 276, .box_w = 14, .box_h = 20, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2516, .adv_w = 208, .box_w = 12, .box_h = 25, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2554, .adv_w = 356, .box_w = 16, .box_h = 20, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2594, .adv_w = 293, .box_w = 18, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2639, .adv_w = 453, .box_w = 28, .box_h = 20, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2709, .adv_w = 294, .box_w = 18, .box_h = 29, .ofs_x = 0, .ofs_y = -9},
    {.bitmap_index = 2775, .adv_w = 271, .box_w = 14, .box_h = 20, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2810, .adv_w = 325, .box_w = 16, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2868, .adv_w = 356, .box_w = 16, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 2920, .adv_w = 348, .box_w = 18, .box_h = 29, .ofs_x = 2, .ofs_y = 0}
};
...
static const uint8_t glyph_id_ofs_list_0[] = {
    ...
    0, 21, 0, 22, 23, 24, 25, 26,
    27, 0, 28, 29, 0, 30, 31, 0,
    0, 0, 0, 0, 0, 0, 0, 0,
