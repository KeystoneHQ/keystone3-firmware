 ...
 * Size: 36 px
 * Bpp: 1
 * Opts: --bpp 1 --size 36 --no-compress --font NotoSans-Regular.ttf --symbols "!#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~£¥·éñó€  --format lvgl -o ../gui_assets/font/es/esTitle.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4578, .adv_w = 325, .box_w = 16, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4636, .adv_w = 356, .box_w = 16, .box_h = 26, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 4688, .adv_w = 348, .box_w = 18, .box_h = 29, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 4754, .adv_w = 329, .box_w = 19, .box_h = 26, .ofs_x = 1, .ofs_y = 0}
};
...
static const uint16_t unicode_list_1[] = {
    0x0, 0x2, 0x14, 0x46, 0x4e, 0x50, 0x2009
};
