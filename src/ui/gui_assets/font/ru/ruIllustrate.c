 ...
 * Size: 20 px
 * Bpp: 2
 * Opts: --bpp 2 --size 20 --no-compress --font NotoSans-Regular.ttf --symbols "!#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~£¥«·»АБВГДЕЗИЙКЛМНОПРСТУФХЧШЬЭЯабвгдежзийклмнопрстуфхцчшщыьэюяё–—€갑결니다드를사세수습없연요용은재지코통하할해현  --format lvgl -o ../gui_assets/font/ru/ruIllustrate.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 5449, .adv_w = 320, .box_w = 20, .box_h = 2, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 5459, .adv_w = 183, .box_w = 12, .box_h = 14, .ofs_x = 0, .ofs_y = 0}
};
...
static const uint16_t unicode_list_4[] = {
    0x0, 0x1, 0x2, 0x3, 0x4, 0x6, 0x1bc8, 0x1bc9,
    0x1c61
};
