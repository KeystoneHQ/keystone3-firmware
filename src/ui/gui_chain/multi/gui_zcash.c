...
void *GuiGetZcashGUIData(void)
{
    ...
    do {
            ...
            parseResult = parse_zcash_tx_cypherpunk(data, ufvk, sfp, GetZcashNetworkType());
    #endif
...
PtrT_TransactionCheckResult GuiGetZcashCheckResult(void)
{
    ...
    GetZcashUFVK(GetCurrentAccountIndex(), ufvk);
    return check_zcash_tx_cypherpunk(data, ufvk, sfp, zcash_account_index, mnemonicType == MNEMONIC_TYPE_SLIP39, GetZcashNetworkType());
#endif
}
