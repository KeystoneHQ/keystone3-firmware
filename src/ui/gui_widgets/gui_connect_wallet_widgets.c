...
static void ShowEgAddressCont(lv_obj_t *egCont)
{
    ...
    if (
        !(g_connectWalletTileView.walletIndex == WALLET_LIST_SOLFARE && GetCurrentSelectedIndex() == SOLBip44ROOT)
        && !(g_connectWalletTileView.walletIndex == WALLET_LIST_SENDER && GetCurrentSelectedIndex() == 0)
    )
    {
...
static void OpenDerivationPath()
{
    ...
    lv_obj_t *cont = GuiCreateContainerWithParent(scrollCont, 408, height);
