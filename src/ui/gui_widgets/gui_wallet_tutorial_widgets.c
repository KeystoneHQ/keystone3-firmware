...
static void WalletTutorialsInit() {
  ...
  g_tutorials[WALLET_LIST_METAMASK].items[1].walletName =
      _("connect_mm_title2");
  ...
  g_tutorials[WALLET_LIST_SOLFARE].items[0].walletName =
      _("connect_solflare_title");
  g_tutorials[WALLET_LIST_SOLFARE].items[0].url = _("connect_solflare_link");
  g_tutorials[WALLET_LIST_SOLFARE].items[0].qrTitle =
      _("connect_solflare_title");
  ...
  g_tutorials[WALLET_LIST_ETERNL].items[0].walletName =
      _("connect_eternl_title");
  ...
  //  g_tutorials[WALLET_LIST_YOROI].items[0].walletName =
  //  _("connect_yoroi_title"); g_tutorials[WALLET_LIST_YOROI].items[0].url =
  //  _("connect_yoroi_link"); g_tutorials[WALLET_LIST_YOROI].items[0].qrTitle =
  //  _("connect_yoroi_qr_title"); g_tutorials[WALLET_LIST_YOROI].items[0].qrUrl
  //  = _("connect_yoroi_qr_link");

  // WALLET_LIST_Typhon
  g_tutorials[WALLET_LIST_TYPHON].len = 1;
  g_tutorials[WALLET_LIST_TYPHON].desc = _("connect_wallet_desc");
  g_tutorials[WALLET_LIST_TYPHON].items[0].walletName =
      _("connect_typhon_title");
  ...
  g_tutorials[WALLET_LIST_BLOCK_WALLET].items[0].walletName =
      _("connect_block_title");
  g_tutorials[WALLET_LIST_BLOCK_WALLET].items[0].url = _("connect_block_link");
  g_tutorials[WALLET_LIST_BLOCK_WALLET].items[0].qrTitle =
      _("connect_block_title");
  g_tutorials[WALLET_LIST_BLOCK_WALLET].items[0].qrUrl =
      _("connect_block_link");
  ...
  g_tutorials[WALLET_LIST_ZAPPER].items[0].walletName =
      _("connect_zapper_title");
  ...
  g_tutorials[WALLET_LIST_YEARN_FINANCE].items[0].walletName =
      _("connect_yearn_title");
  g_tutorials[WALLET_LIST_YEARN_FINANCE].items[0].url = _("connect_yearn_link");
  g_tutorials[WALLET_LIST_YEARN_FINANCE].items[0].qrTitle =
      _("connect_yearn_title");
  g_tutorials[WALLET_LIST_YEARN_FINANCE].items[0].qrUrl =
      _("connect_yearn_link");

  // WALLET_LIST_SUSHISWAP
  g_tutorials[WALLET_LIST_SUSHISWAP].len = 1;
  g_tutorials[WALLET_LIST_SUSHISWAP].desc = _("connect_wallet_desc");
  g_tutorials[WALLET_LIST_SUSHISWAP].items[0].walletName =
      _("connect_sushi_title");
  g_tutorials[WALLET_LIST_SUSHISWAP].items[0].url = _("connect_sushi_link");
  g_tutorials[WALLET_LIST_SUSHISWAP].items[0].qrTitle =
      _("connect_sushi_title");
  ...
  g_tutorials[WALLET_LIST_IMTOKEN].items[0].walletName =
      _("connect_imtoken_title");
  g_tutorials[WALLET_LIST_IMTOKEN].items[0].url = _("connect_imtoken_link");
  g_tutorials[WALLET_LIST_IMTOKEN].items[0].qrTitle =
      _("connect_imtoken_title");
  ...
  g_tutorials[WALLET_LIST_SPARROW].items[0].walletName =
      _("connect_sparrow_title");
  g_tutorials[WALLET_LIST_SPARROW].items[0].url = _("connect_sparrow_link");
  g_tutorials[WALLET_LIST_SPARROW].items[0].qrTitle =
      _("connect_sparrow_title");
  ...
  g_tutorials[WALLET_LIST_UNISAT].items[0].walletName =
      _("connect_unisat_title");
  g_tutorials[WALLET_LIST_UNISAT].items[0].url = _("connect_unisat_link");
  g_tutorials[WALLET_LIST_UNISAT].items[0].qrTitle =
...
>>>>>>> afa23409 (feat: add generate address and qr connect)
  ...
  g_tutorials[WALLET_LIST_FEWCHA].items[0].walletName =
      _("connect_fewcha_title");
  ...
  g_tutorials[WALLET_LIST_XRP_TOOLKIT].items[0].walletName =
      _("connect_xrp_toolkit_title");
  g_tutorials[WALLET_LIST_XRP_TOOLKIT].items[0].url =
      _("connect_xrp_toolkit_link");
  g_tutorials[WALLET_LIST_XRP_TOOLKIT].items[0].qrTitle =
      _("connect_xrp_toolkit_title");
  g_tutorials[WALLET_LIST_XRP_TOOLKIT].items[0].qrUrl =
      _("connect_xrp_toolkit_link");
#else
  g_tutorials[WALLET_LIST_BLUE].len = 1;
  g_tutorials[WALLET_LIST_BLUE].desc = _("connect_wallet_desc");
  ...
  g_tutorials[WALLET_LIST_SPECTER].items[0].walletName =
      _("connect_specter_title");
  g_tutorials[WALLET_LIST_SPECTER].items[0].url = _("connect_specter_link");
  g_tutorials[WALLET_LIST_SPECTER].items[0].qrTitle =
      _("connect_specter_title");
  ...
  g_tutorials[WALLET_LIST_NUNCHUK].items[0].walletName =
      _("connect_nunchuk_title");
  g_tutorials[WALLET_LIST_NUNCHUK].items[0].url = _("connect_nunchuk_link");
  g_tutorials[WALLET_LIST_NUNCHUK].items[0].qrTitle =
      _("connect_nunchuk_title");
  ...
  if (GetCurrentWalletIndex() != SINGLE_WALLET) {
    ...
    g_tutorials[WALLET_LIST_BLUE].items[0].qrUrl =
        _("connect_bw_multisig_link");
