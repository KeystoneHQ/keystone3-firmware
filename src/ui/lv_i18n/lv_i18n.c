...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"change_passcode_mid_btn", "Ввести код-пароль"},
    ...
    {"seed_check_word_select", "Количество слов в семенной фразе"},
    ...
    {"unlock_device_attempts_left_singular_times_fmt", "Неверный пароль, Осталось %d попытки"},
    ...
    {"wallet_setting_add_wallet_limit_desc", "Вы можете добавить максимум 3 кошелька. Пожалуйста, удалите другие кошельки, прежде чем добавлять новый кошелек."},
