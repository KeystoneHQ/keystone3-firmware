...
static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"change_entropy_dice_detail_desc_1", "You need to roll at least #F5870A 128 bits# to generate a seed phrase, and it is recommended roll more than #F5870A 256 bits# for sufficient randomness."},
