...
static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"multisig_import_wallet_invalid", "Invalid Wallet"},
    {"multisig_import_wallet_invalid_desc", "The multisig wallet you selected has wrong data, please check your key in the file."},
