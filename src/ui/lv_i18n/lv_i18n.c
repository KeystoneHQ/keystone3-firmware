...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"import_wallet_single_phrase_desc", "Sie benötigen eine 12/18/24-Mnemonic-Phrase,\r\num Ihre Brieftasche wiederherzustellen."},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"connect_wallet_key_request_fmt", "%s Walletは、あなたのKeystone上の公開鍵情報を取得したいです:"},
    ...
    {"import_wallet_shamir_backup_desc", "ウォレットを回復するには、いくつかのシードフレーズの共有が必要です."},
    ...
    {"single_phrase_title", "シードをバックアップしてください"},
