...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"receive_eth_more_derivation_path_desc", "이더리움에 사용할 파생 경로를 선택하십시오"},
    ...
    {"shamir_phrase_verify_success_title", "인증 성공"},
    ...
    {"wallet_phrase_20words", "20개 단어"},
    {"wallet_phrase_24words", "24개 단어"},
    {"wallet_phrase_33words", "33개 단어"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"receive_eth_more_t_title1", "Узнать различия: стандартные, Ledger Live и устаревшие пути вывода в Ethereum"},
    ...
    {"wallet_phrase_20words", "20 слова"},
    ...
    {"write_se_desc", "Идет запись на SE чип..."},
    {NULL, NULL} // End mark
};
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"firmware_update_desc1", "请确保您的设备电量高于20%"},
    {"firmware_update_desc2", "使用计算机或智能手机转到Keystone的固件更新页面"},
