...
static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"error_box_duplicated_seed_phrase_desc", "The seed phrase you've entered is already being used in a wallet account. Please use a different seed for the import process."},
    ...
    {"import_wallet_ssb_12words", "20 Words"},
    {"import_wallet_ssb_18words", "33 Words"},
    ...
    {"shamir_phrase_verify_success_title", "Verification Successful"},
