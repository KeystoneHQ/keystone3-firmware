...
static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"about_info_firmware_version_head", "прошивки"},
    ...
    {"about_info_verify_firmware_step2", "Нажмите кнопку #F5870A контрольную сумму# рядом с загрузкой микропрограммы."},
    {"about_info_verify_firmware_step3", "Нажмите кнопку #F5870A Показать контрольную сумму# ниже и сравните информацию"},
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "счет"},
    {"calculat_modal_title", "Вычисление"},
    {"change_entropy", "Смена Энтропии"},
    {"change_entropy_desc", "Выберите Энтропию для создания кошельков"},
    {"change_entropy_dice_desc", "Создайте сид фразу с помощью случайных чисел, полученных при бросании кубиков."},
    {"change_entropy_dice_detail_desc_1", "Чтобы сгенерировать сид фразу, нужно бросить не менее #F5870A 50 раз#, а для достаточной случайности рекомендуется бросить более #F5870A 99 раз#."},
    {"change_entropy_dice_detail_desc_2", "Мы рекомендуем использовать стандартные игральные кости, чтобы увеличить энтропию каждого броска."},
    {"change_entropy_dice_rolls", "Игральные кости"},
    {"change_entropy_dice_rolls_subtitle", "Использовать Игральные кости"},
    {"change_entropy_system", "Системная"},
    {"change_entropy_system_desc", "Создайте сид фразу с помощью генератора случайных чисел безопасного чипа Keystone."},
    {"change_entropy_system_subtitle", "Использовать энтропию SE чипа"},
    ...
    {"create_wallet_generating_title", "Создание кошелька, не выключайте кошелек"},
    ...
    {"derivation_path_near_ledger_live_desc", ""},
    {"derivation_path_near_standard_desc", "Рекомендуется. Широко применяется во многих кошельках NEAR."},
    ...
    {"dice_roll_cancel_desc", "Если вы откажетесь, все введенные вами числа будут потеряны."},
    {"dice_roll_cancel_title", "Отменить генерацию через броски кубиков?"},
    {"dice_roll_error_label", "Недостаточная случайность"},
    {"dice_roll_hint_label", "Не менее 50 раз"},
    {"dice_roll_max_limit_label", "Вы достигли максимального числа"},
    {"dice_rolls_entropy_hint", "Подбрасывайте кубики"},
    ...
    {"fingerprint_add_password", "Теперь нужно ввести код-пароль для шифрования и хранения отпечатка пальца."},
    ...
    {"firmware_update_no_upgradable_firmware_desc", "Версия прошивки устройства выше или равна версии прошивки на microSD карте."},
    {"firmware_update_no_upgradable_firmware_title", "Новая прошивка не обнаружена"},
    ...
    {"firmware_update_sd_checksum_notice", "Это дополнительная функция для повышения безопасности. Сравните приведенную ниже контрольную сумму с контрольной суммой пакета загрузки на официальном сайте и убедитесь, что они совпадают."},
    ...
    {"import_wallet_single_backup_desc", "Восстановите кошелек с помощью соответствующей сид фразы. Завершите процесс настройки за один раз, чтобы избежать рисков безопасности."},
    ...
    {"passphrase_add_password", "Теперь нужно ввести код-пароль, чтобы настроить кошелек с кодовой фразой."},
    ...
    {"receive_btc_extended_public_key", "Расширенный ключ"},
    ...
    {"receive_sol_more_t_base_path", "УПуть на основе учетной записи"},
    ...
    {"receive_sol_more_t_single_path", "Путь к единой учетной записи"},
    {"receive_sol_more_t_sub_path", "Путь субсчета"},
    ...
    {"shamir_phrase_notice_desc2", "Убедитесь в отсутствии посторонних лиц и камер во время записи сид фразы.\r\nЗавершите процесс настройки за один раз, чтобы избежать рисков безопасности."},
    ...
    {"shamir_phrase_share_confirm_notice_fmt", "Выберите слова ниже в правильном порядке фразы Части #F5870A %d#, чтобы подтвердить сид фразу."},
    ...
    {"try_again", "Повторить"},
    {"tutorial_change_entropy_desc1", "Энтропия - это мера случайности. В криптографии она обеспечивает непредсказуемость таких вещей, как пароли или ключи, что делает их более безопасными."},
    {"tutorial_change_entropy_desc2", "Компьютеры не умеют быть по-настоящему случайными. Броски кубиков - это физический, непредсказуемый источник случайности. Используя их, вы повышаете безопасность криптографических процессов, затрудняя кому-либо предсказание или взлом ваших кодов."},
    {"tutorial_change_entropy_qr_link1", "https://keyst.one/"},
    {"tutorial_change_entropy_qr_title1", "Зачем использовать броски кубиков в качестве энтропии?"},
    {"tutorial_change_entropy_title1", "Что такое Энтропия?"},
    {"tutorial_change_entropy_title2", "Зачем использовать броски кубиков в качестве энтропии?"},
    ...
    {"unlock_device_time_limited_error_max_desc", "Разблокируйте ваше устройство в течение #F55831 1# минуты."},
    {"unlock_device_time_limited_error_max_desc_fmt", "Разблокируйте свое устройство через #F55831 %d# минут"},
    ...
    {"usb_transport_connect_rabby", "Rabby Wallet хочет подключить ваш Keystone через USB"},
    ...
    {"usb_transport_mismatched_wallet_title", "Несоответствие кошелька"},
    {"usb_transport_sign_completed_btn", "Готово"},
    {"usb_transport_sign_completed_subtitle", "Смотрите детали транзакции в программном кошельке"},
    {"usb_transport_sign_completed_title", "Подпись выполнена"},
    {"usb_transport_sign_failed_btn", "Хорошо"},
    {"usb_transport_sign_failed_title", "Ошибка подписи"},
    {"usb_transport_sign_unkown_error_message", "Невозможно распознать информацию"},
    ...
    {"wallet_setting_stop_add_fingerprint_desc", "Отпечаток пальца не сохранен. При отмене вам потребуется повторно ввести отпечаток пальца."},
