...
static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"derivation_path_sol_1_desc", "Account-based Path, Multiple accounts, Commonly used by Solflare."},
    {"derivation_path_sol_2_desc", "Single Account Path, a single Solana account, Used by Sollet and MathWallet."},
    {"derivation_path_sol_3_desc", "Sub-account Path, Extra layers, Utilized by Phantom and Exodus."},
    ...
    {"fingerprint_add_desc", "Place your finger on the sensor and remove it when you feel a vibration"},
    {"fingerprint_add_failed", "Failed to Add"},
    {"fingerprint_add_failed_duplicate", "Duplicate finger, Please change the other finger."},
    ...
    {"fingerprint_nth_remove_desc", "Are you sure to remove fingerprint%d?"},
