...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"boot_update_desc1", "The device will update to enhance security. Please ensure:"},
    {"boot_update_desc2", "· the device has at least #F5870A 40%# battery"},
    {"boot_update_desc3", "· Power adapter is connected"},
    {"boot_update_desc4", "This process may take up to #F5870A 5 minutes#"},
    {"boot_update_desc5", "#F5870A DO NOT# disconnect power or perform any operations."},
    {"boot_update_limit_desc", "Ensure the device has at least 40% battery and is connected to a power source to proceed."},
    {"boot_update_limit_title", "Power Requirements"},
    {"boot_update_title", "Update Bootloader"},
    ...
    {"connect_wander_link", "https://keyst.one/t/3rd/wander"},
    {"connect_wander_title", "Wander"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"boot_update_desc1", "Geräteupdate zur Sicherheitsverbesserung:"},
    {"boot_update_desc2", "· Batterie mind. #F5870A 40%#"},
    {"boot_update_desc3", "· Netzteil angeschlossen"},
    {"boot_update_desc4", "Dieser Vorgang kann bis zu #F5870A 5 Minuten# dauern."},
    {"boot_update_desc5", "#F5870A SCHALTEN# Sie die Batterie nicht ab oder führen Sie keine Operationen aus."},
    ...
    {"boot_update_limit_title", "Leistungsanforderungen"},
    {"boot_update_title", "Bootloader-Update"},
    ...
    {"error_box_low_power_desc", "Das Gerät benötigt mindestens 40% Akkulaufzeit, um den Vorgang fortzusetzen."},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"boot_secure_switch_btn", "Comprobar seguridad de arranque"},
    ...
    {"boot_update_desc1", "Actualización del dispositivo para mejorar seguridad:"},
    {"boot_update_desc2", "· Batería al menos #F5870A 40%#"},
    {"boot_update_desc3", "· Netzteil angeschlossen"},
    {"boot_update_desc4", "Este proceso puede durar hasta #F5870A 5 minutos#."},
    {"boot_update_desc5", "#F5870A NO# desconecte la batería o realice ninguna operación."},
    ...
    {"boot_update_limit_title", "Requisitos de alimentación"},
    {"boot_update_title", "Actualizar cargador"},
    ...
    {"error_box_low_power_desc", "El dispositivo necesita un mínimo del 40% de carga de batería para continuar con el proceso"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"boot_update_desc1", "デバイスセキュリティ更新:"},
    {"boot_update_desc2", "· バッテリー#F5870A 40%#以上"},
    {"boot_update_desc3", "·電源接続"},
    {"boot_update_desc4", "このプロセスは最大#F5870A 5分#"},
    {"boot_update_desc5", "かかる場合があります。電源を切らないでください。"},
    {"boot_update_limit_desc", "デバイスが少なくとも40%のバッテリーを持ち、電源ソースに接続されていることを確認してください。"},
    {"boot_update_limit_title", "電源要件"},
    {"boot_update_title", "ブートローダーの更新"},
    ...
    {"error_box_low_power_desc", "デバイスは、プロセスを続けるために最低40%のバッテリー残量が必要です."},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"boot_secure_switch_desc", "보안 부팅을 비활성화하면 보안 위험이 발생할 수 있습니다."},
    {"boot_secure_switch_title", "부트 보안 확인"},
    {"boot_update_desc1", "장치 보안 강화를 위한 업데이트 중:"},
    {"boot_update_desc2", "· 배터리 최소 #F5870A 40%#"},
    {"boot_update_desc3", "·전원 어댑터 연결"},
    {"boot_update_desc4", "이 프로세스는 최대 #F5870A 5분# 걸릴 수 있습니다."},
    {"boot_update_desc5", "#F5870A 전원을 끄거나 작업을 수행하지 마세요."},
    {"boot_update_limit_desc", "장치가 최소 #F5870A 40%# 배터리를 갖고 전원 소스에 연결되어 있는지 확인하세요."},
    {"boot_update_limit_title", "전원 요구 사항"},
    {"boot_update_title", "부트로더 업데이트"},
    ...
    {"error_box_low_power_desc", "펌웨어 업그레이드는 장비의 최소 40% 이상을 확보해야 합니다."},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"boot_secure_switch_btn", "Проверка безопасности загрузки"},
    ...
    {"boot_update_desc1", "Устройство будет обновлено для повышения безопасности. Убедитесь:"},
    {"boot_update_desc2", "· Батарея не менее #F5870A 40%#"},
    {"boot_update_desc3", "· Подключен сетевой адаптер"},
    {"boot_update_desc4", "Процесс может занять до #F5870A 5 минут#."},
    {"boot_update_desc5", "#F5870A НЕ# отключайте питание или выполняйте какие-либо операции."},
    ...
    {"boot_update_limit_title", "Требования к питанию"},
    {"boot_update_title", "Обновление загрузчика"},
    ...
    {"error_box_low_power_desc", "Для продолжения процесса устройству требуется минимум 40% заряда батареи."},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"boot_update_desc1", "设备正在更新以提高安全性："},
    {"boot_update_desc2", "· 确保电池电量至少#F5870A 40%#"},
    {"boot_update_desc3", "· Power adapter is connected"},
    {"boot_update_desc4", "这个过程可能需要#F5870A 5分钟#。"},
    {"boot_update_desc5", "#F5870A 请勿#断开电源或执行任何操作。"},
    {"boot_update_limit_desc", "确保设备至少有40%的电量并连接到电源源以继续。"},
    {"boot_update_limit_title", "电源要求"},
    {"boot_update_title", "更新引导程序"},
    ...
    {"error_box_low_power_desc", "固件升级需要确保设备至少有 40% 以上的电量."},
