...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"about_info_export_log", "Exportieren Sie das Systemprotokoll."},
    ...
    {"change_passcode_mid_btn", "Geben Sie den Zugangscode ein."},
    ...
    {"connect_bw_link", "I'm sorry, but I cannot access external sources or websites. However, if you provide the text directly, I'll be happy to translate it for you into German."},
    {"connect_bw_multisig_link", "https://keyst.one/t/3rd/Multisig/bw"},
    {"connect_bw_title", "BlueWallet (Mobile)"},
    {"connect_eternl_link", "https://keyst.one/t/3rd/eternl"},
    {"connect_eternl_title", "Eternl (Web)"},
    ...
    {"connect_safe_link", "https://keyst.one/t/3rd/safe"},
    {"connect_safe_link2", "https://keyst.one/t/3rd/safem"},
    {"connect_safe_title", "Sicher (Web)"},
    {"connect_safe_title2", "Sicher (Mobil)"},
    {"connect_solflare_link", "https://keyst.one/t/3rd/solflare"},
    {"connect_solflare_title", "Solflare"},
    {"connect_sparrow_link", "https://keyst.one/t/3rd/sperling"},
    {"connect_sparrow_multisig_link", "https://keyst.one/t/3rd/Multisig/spatz"},
    {"connect_sparrow_title", "Spatz"},
    {"connect_specter_link", "https://keyst.one/t/3rd/specter"},
    {"connect_specter_title", "Specter"},
    {"connect_sushi_link", "https://keyst.one/t/3rd/sushi"},
    {"connect_sushi_title", "SushiSwap"},
    ...
    {"connect_wallet_supported_tokens", ""},
    ...
    {"derivation_path_btc_1_desc", ""},
    {"derivation_path_btc_2_desc", ""},
    {"derivation_path_btc_3_desc", ""},
    ...
    {"enter_passcode", "Geben Sie den Zugangscode ein."},
    ...
    {"fingerprint_add_overlaps_too_much", ""},
    {"fingerprint_add_password", "Jetzt benötigen wir Ihre Eingabeaufforderung, um Ihren Zugangscode zur Verschlüsselung und Speicherung des Fingerabdrucks einzugeben."},
    {"fingerprint_add_poor_qualtiy", ""},
    {"fingerprint_add_success", "Erfolgreich hinzufügen"},
    {"fingerprint_add_too_wet", ""},
    {"fingerprint_nth", "Finger %d"},
    ...
    {"firmware_update_sd_checksum_done", "Checksum: Prüfsumme"},
    ...
    {"firmware_update_sd_dialog_desc", ""},
    {"firmware_update_sd_dialog_head", "Verfügbar"},
    {"firmware_update_sd_dialog_title", ""},
    ...
    {"got_it_start", "Habe es verstanden (5)."},
    ...
    {"import_wallet_shamir_backup", "'Shamir Backup' bleibt unverändert."},
    ...
    {"multisig_decoding_qr_link", "https://keyst.one/t/3rd/Multisig/import => \"https://keyst.one/t/3rd/Multisig/import"},
    ...
    {"password_error_too_weak", "Wählen Sie ein starkes Passwort"},
    ...
    {"sdcard_format_subtitle", "Formatieren Sie die MicroSD-Karte."},
    ...
    {"sdcard_format_text", "Formatieren Sie die MicroSD-Karte."},
    ...
    {"seed_check_share_phrase", "'Shamir Backup' bleibt unverändert."},
    ...
    {"seed_check_single_phrase", "Standard Seed Phrase: Standarder Seed-Satz"},
    ...
    {"shamir_backup", "'Shamir Backup' bleibt unverändert."},
    ...
    {"single_backup_shamir_title", "'Shamir Backup' bleibt unverändert."},
    {"single_backup_single_phrase_desc", "12 oder 24 Seed-Phrase-Backup. Am häufigsten verwendete Methode."},
    {"single_backup_single_phrase_title", "Standard Seed Phrase: Standarder Seed-Satz"},
    ...
    {"wallet_setting_add_wallet_limit", "Add Limited' = 'Hinzufügen Beschränkt"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"about_info_verify_firmware_desc", "これは開発者向けの高度な機能で、Keystone デバイス上で実行されるファームウェアがオープンソース化されたものと一致していることを検証するためのものです."},
    {"about_info_verify_firmware_step1", "KeystoneのオープンソースのGitHubリポジトリに行って、ファームウェアをビルドするための手順に従い、チェックサムを取得してください."},
    ...
    {"change_passcode_mid_btn", "パスコードを入力してください."},
    ...
    {"connect_arconnect_title", ""},
    {"connect_block_link", "https://keyst.one/t/3rd/block"},
    {"connect_block_title", "ブロックウォレット(エクステンション)"},
    {"connect_bw_link", "https://keyst.one/t/3rd/bw"},
    {"connect_bw_multisig_link", "https://keyst.one/t/3rd/Multisig/bw"},
    ...
    {"connect_fewcha_link", "https://keyst.one/t/3rd/fewcha"},
    {"connect_fewcha_title", "未来(エクステンション)"},
    {"connect_head", "接続"},
    {"connect_imtoken_link", "https://keyst.one/t/3rd/imtoken."},
    ...
    {"connect_mm_link", "https://keyst.one/t/3rd/mm"},
    {"connect_mm_link2", "https://keyst.one/t/3rd/mmm."},
    {"connect_mm_title", "メタマスク(拡張機能)"},
    {"connect_mm_title2", "MetaMask(モバイル)"},
    {"connect_nunchuk_multisig_link", "https://keyst.one/t/3rd/Multisig/nunchuk"},
    {"connect_nunchuk_title", "ヌンチャク(モバイル)"},
    {"connect_okx_link", "https://keyst.one/t/3rd/okx"},
    {"connect_okx_link2", "https://keyst.one/t/3rd/okxm."},
    {"connect_okx_title", "OKXウォレット(エクステンション)"},
    {"connect_okx_title2", "OKXウォレット(モバイル)"},
    {"connect_petra_link", "https://keyst.one/t/3rd/petra"},
    {"connect_petra_title", "ペトラ(エクステンション)"},
    {"connect_rabby_link", "https://keyst.one/t/3rd/rabby."},
    {"connect_rabby_title", "ラビー(拡張機能)"},
    {"connect_safe_link", "https://keyst.one/t/3rd/safe"},
    {"connect_safe_link2", "https://keyst.one/t/3rd/safem"},
    {"connect_safe_title", "安全な(ウェブ)"},
    {"connect_safe_title2", "安全(モバイル)"},
    {"connect_solflare_link", "https://keyst.one/t/3rd/solflare"},
    {"connect_solflare_title", "ソルフレア"},
    {"connect_sparrow_link", "https://keyst.one/t/3rd/sparrow"},
    {"connect_sparrow_multisig_link", "https://keyst.one/t/3rd/Multisig/sparrow"},
    {"connect_sparrow_title", "スパロウ"},
    {"connect_specter_link", "https://keyst.one/t/3rd/specter"},
    {"connect_specter_title", "Specter"},
    {"connect_sushi_link", "「https://keyst.one/t/3rd/sushi"},
    {"connect_sushi_title", "SushiSwap"},
    ...
    {"connect_yearn_link", "https://keyst.one/t/3rd/yearn"},
    {"connect_yearn_title", "憧れる"},
    {"connect_zapper_link", "'https://keyst.one/t/3rd/zapper"},
    {"connect_zapper_title", "ザッパー"},
    ...
    {"firmware_update_sd_copying_title", ""},
    {"firmware_update_sd_desc2_link", "https://keyst.one/firmware"},
    ...
    {"firmware_update_sd_dialog_desc", ""},
    {"firmware_update_sd_dialog_head", "利用できる"},
    {"firmware_update_sd_dialog_title", ""},
    ...
    {"password_error_too_weak", "強力なパスワードを設定してください."},
    ...
    {"rsa_confirm_hintbox_cancel", "ただいまではありません."},
    {"rsa_confirm_hintbox_context", ""},
    {"rsa_confirm_hintbox_ok", ""},
    {"rsa_confirm_hintbox_title", ""},
    ...
    {"tx_details_eth_decoding_qr_link", ""},
    {"tx_details_eth_decoding_qr_title", "デフィトランザクションの解読"},
    {"unknown_transaction_desc", ""},
    {"unknown_transaction_title", ""},
    {"unlock_device", "デバイスのロックを解除"},
    {"unlock_device_attempts_left_plural_times_fmt", "パスワードが間違っています.残り%d回の試行機会があります."},
    {"unlock_device_attempts_left_singular_times_fmt", "パスワードが違います、残り%d回の試行機会があります."},
    ...
    {"verify_cont1", "ウェブサイトを訪れて、#F5870A認証を開始#ボタンをクリックしてください."},
