...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"derivation_path_btc_4_desc", "Taproot: 프라이버시와 효율성 향상, 'bc1p'로 시작"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"derivation_path_btc_4_desc", "Taproot:增强隐私和效率,以 \"tb1p.\" 开头"},
    ...
    {"single_backup_setpin_title", "设置PIN码"},
