...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"invaild_ada_path", "Invaild Ada Path"},
    {"invaild_ada_path_con", "path is not ada prefix"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"invaild_ada_path", "Ungültiger Ada-Pfad"},
    {"invaild_ada_path_con", "Der Pfad ist kein ada-Präfix"},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"invaild_ada_path", "Ruta Ada no válida"},
    {"invaild_ada_path_con", "La ruta no es un prefijo ada"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"invaild_ada_path", "無効な Ada パス"},
    {"invaild_ada_path_con", "パスが ada プレフィックスではありません"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"invaild_ada_path", "잘못된 Ada 경로"},
    {"invaild_ada_path_con", "경로가 ada 접두사가 아닙니다"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"invaild_ada_path", "Недопустимый путь Ada"},
    {"invaild_ada_path_con", "Путь не является префиксом ada"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"invaild_ada_path", "无效的 Ada 路径"},
    {"invaild_ada_path_con", "路径不是 ada 前缀"},
