...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"Pending", "Pending"},
    {"Policy", "Policy"},
    {"PreparingArAddress", "Preparing AR address..."},
    ...
    {"ada_multi_assets_warning", "Contains native assets. Verify amounts, names, and policy IDs."},
    {"ada_proposals_tx_notice", "Please note, you are currently signing a transaction related to a voting proposal."},
    {"ar_address_setup_desc", "Please return to Home to complete your AR address setup first."},
    {"ar_address_setup_required", "AR Address Setup Required"},
    {"ar_preparation_address_notice", "Different wallets may generate different AR addresses from the same seed phrase. After connecting to a software wallet, make sure its address matches the one on this device."},
    {"ar_preparation_power_notice", "Start with at least 80% battery and keep USB power connected throughout the process. It may take about 10 minutes."},
    {"ar_preparation_title", "AR Address Preparation"},
    ...
    {"change_entropy_dice_detail_desc_1", "You need to roll at least #F5870A 50# #F5870A times# to generate a seed phrase, and it is recommended to roll more than #F5870A 99# #F5870A times# for sufficient randomness."},
    {"change_entropy_dice_detail_desc_2", "We recommend you use casino dice to increase the entropy of each dice throw."},
    ...
    {"firmware_check_desc", "Keep your firmware up to date for the latest improvements, features, and a better experience."},
    {"firmware_check_qr_title", "Check The Latest Firmware"},
    {"firmware_check_step1", "Visit our website and check the latest firmware version in the changelog."},
    {"firmware_check_step2", "Compare it with your device’s firmware version."},
    {"firmware_check_step3", "Make sure your firmware is up to date."},
    {"firmware_check_title", "Firmware Version Check"},
    {"firmware_check_up_to_date", "My Firmware is up to date"},
    {"firmware_check_update", "Update Firmware"},
    {"firmware_check_version_fmt", "Firmware Version: %s"},
    ...
    {"firmware_update_recommended_desc", "Update your firmware to the latest version for improved security, features, and compatibility."},
    {"firmware_update_recommended_title", "Update Recommended"},
    ...
    {"firmware_update_skip_fmt", "Skip (%ds)"},
    ...
    {"import_wallet_phrase_desc", "Enter your seed phrase in the correct order."},
    ...
    {"iota_gas_sponsor_notice", "The transaction fee will be paid by another account."},
    {"iota_max_amount_notice", "This transfers the entire coin object. The final amount depends on the transaction fee and cannot be shown before execution."},
    {"iota_message_raw_data_notice", "Message cannot be displayed as text. Review the raw data carefully before signing."},
    {"iota_unknown_transaction_desc", "Not recognized as a standard Transfer or Stake. Review the raw data carefully before signing."},
    {"iota_unknown_transaction_title", "Unknown Transaction"},
    ...
    {"seed_backup_confirm_check", "I’ve backed it up securely."},
    {"seed_backup_confirm_desc", "Double-check all words and their order. They cannot be viewed again after setup."},
    {"seed_backup_confirm_title", "Confirm Your Backup"},
    ...
    {"seed_phrase_privacy_notice", "Keep it securely backed up and private."},
    ...
    {"single_backup_notice_item1", "Hardware wallet is for personal use only. Never share your device with others."},
    {"single_backup_notice_item2", "Back up your seed phrase. It cannot be viewed or exported later."},
    {"single_backup_notice_item3", "Never share your seed phrase. It grants access to your assets."},
    {"single_backup_notice_page_desc", "Please read these important safety notes carefully before you continue."},
    {"single_backup_notice_page_title", "Notice"},
    ...
    {"single_phrase_desc", "Write down your seed phrase in the correct order."},
    ...
    {"solana_blind_sign_title", "Blind Sign"},
    ...
    {"system_settings_wipe_device_wipe_alert_desc", "All wallets and data on this device will be permanently deleted. This action cannot be undone."},
    {"system_settings_wipe_device_wipe_backup_desc", "Make sure your seed phrase is securely backed up. It grants access to your wallet and assets."},
    {"system_settings_wipe_device_wipe_button", "Wipe Device Now"},
    {"system_settings_wipe_device_wipe_desc", "All data on this device, including your wallets, will be permanently deleted."},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"Pending", "Anhängig"},
    {"Policy", "Politik"},
    {"PreparingArAddress", "AR-Adresse wird vorbereitet..."},
    ...
    {"about_terms_website_url", "https://keyst.one/terms "},
    {"account_head", "Konto"},
    {"ada_multi_assets_warning", "Enthält native Assets. Beträge, Namen und Policy-IDs prüfen."},
    ...
    {"ar_address_setup_desc", "Bitte kehre zur Startseite zurück und schließe zuerst die Einrichtung deiner AR-Adresse ab."},
    {"ar_address_setup_required", "AR-Adresse muss eingerichtet werden"},
    {"ar_preparation_address_notice", "Verschiedene Wallets können aus derselben Seed-Phrase unterschiedliche AR-Adressen erzeugen. Prüfe nach dem Verbinden mit einer Software-Wallet, ob deren Adresse mit der Adresse auf diesem Gerät übereinstimmt."},
    {"ar_preparation_power_notice", "Starte mit mindestens 80% Akkuladung und lasse die USB-Stromversorgung während des gesamten Vorgangs angeschlossen. Der Vorgang kann etwa 10 Minuten dauern."},
    {"ar_preparation_title", "AR-Adresse vorbereiten"},
    ...
    {"change_entropy_dice_detail_desc_1", "Sie müssen mindestens #F5870A 50# #F5870A Mal# würfeln, um eine Seed-Phrase zu generieren, und es wird empfohlen, mehr als #F5870A 99# #F5870A Mal# zu würfeln, um ausreichende Zufälligkeit zu gewährleisten."},
    ...
    {"firmware_check_desc", "Halten Sie Ihre Firmware aktuell, um die neuesten Verbesserungen und Funktionen zu erhalten und ein besseres Erlebnis zu genießen."},
    {"firmware_check_qr_title", "Neueste Firmware prüfen"},
    {"firmware_check_step1", "Besuchen Sie unsere Website und prüfen Sie die neueste Firmware-Version im Änderungsprotokoll."},
    {"firmware_check_step2", "Vergleichen Sie sie mit der Firmware-Version Ihres Geräts."},
    {"firmware_check_step3", "Stellen Sie sicher, dass Ihre Firmware aktuell ist."},
    {"firmware_check_title", "Firmwareversion prüfen"},
    {"firmware_check_up_to_date", "Meine Firmware ist aktuell"},
    {"firmware_check_update", "Firmware aktualisieren"},
    {"firmware_check_version_fmt", "Firmware-Version: %s"},
    ...
    {"firmware_update_desc", "Aktualisieren Sie die Firmware für neue Funktionen."},
    ...
    {"firmware_update_recommended_desc", "Aktualisieren Sie Ihre Firmware auf die neueste Version, um Sicherheit, Funktionen und Kompatibilität zu verbessern."},
    {"firmware_update_recommended_title", "Update empfohlen"},
    ...
    {"firmware_update_skip_fmt", "Überspringen (%ds)"},
    {"firmware_update_title", "Firmware-Update"},
    ...
    {"import_wallet_phrase_desc", "Geben Sie Ihre Seed-Phrase in der richtigen Reihenfolge ein."},
    ...
    {"iota_gas_sponsor_notice", "Die Transaktionsgebühr wird von einem anderen Konto bezahlt."},
    {"iota_max_amount_notice", "Dadurch wird das gesamte Coin-Objekt übertragen. Der endgültige Betrag hängt von der Transaktionsgebühr ab und kann vor der Ausführung nicht angezeigt werden."},
    {"iota_message_raw_data_notice", "Die Nachricht kann nicht als Text angezeigt werden. Prüfen Sie die Rohdaten vor dem Signieren sorgfältig."},
    {"iota_unknown_transaction_desc", "Nicht als standardmäßige Übertragung oder Staking erkannt. Bitte überprüfen Sie die Rohdaten sorgfältig, bevor Sie signieren."},
    {"iota_unknown_transaction_title", "Unbekannte Transaktion"},
    ...
    {"seed_backup_confirm_check", "Sicher gesichert."},
    {"seed_backup_confirm_desc", "Prüfen Sie alle Wörter und ihre Reihenfolge. Danach sind sie nicht mehr sichtbar."},
    {"seed_backup_confirm_title", "Backup bestätigen"},
    ...
    {"seed_phrase_privacy_notice", "Bewahren Sie sie sicher und geheim auf."},
    ...
    {"single_backup_notice_item1", "Die Hardware-Wallet ist nur für den persönlichen Gebrauch bestimmt. Teilen Sie Ihr Gerät niemals mit anderen."},
    {"single_backup_notice_item2", "Sichern Sie Ihre Seed-Phrase. Sie kann später weder angezeigt noch exportiert werden."},
    {"single_backup_notice_item3", "Geben Sie Ihre Seed-Phrase niemals weiter. Sie gewährt Zugriff auf Ihre Vermögenswerte."},
    {"single_backup_notice_page_desc", "Bitte lesen Sie diese wichtigen Sicherheitshinweise sorgfältig durch, bevor Sie fortfahren."},
    {"single_backup_notice_page_title", "Hinweis"},
    ...
    {"single_phrase_desc", "Schreiben Sie Ihre Seed-Phrase in der richtigen Reihenfolge auf."},
    ...
    {"solana_blind_sign_title", "Blindes Signieren"},
    ...
    {"system_settings_wipe_device_wipe_alert_desc", "Alle Wallets und Daten auf diesem Gerät werden dauerhaft gelöscht. Diese Aktion kann nicht rückgängig gemacht werden."},
    {"system_settings_wipe_device_wipe_backup_desc", "Stellen Sie sicher, dass Ihre Seed-Phrase sicher gesichert ist. Sie gewährt Zugriff auf Ihre Wallet und Vermögenswerte."},
    {"system_settings_wipe_device_wipe_button", "Lösche Gerät jetzt"},
    {"system_settings_wipe_device_wipe_desc", "Alle Daten auf diesem Gerät, einschließlich Ihrer Wallets, werden dauerhaft gelöscht."},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"Pending", "Pendiente"},
    {"Policy", "Política"},
    {"PreparingArAddress", "Preparando dirección AR..."},
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "Cuenta"},
    {"ada_multi_assets_warning", "Contiene activos nativos. Verifique importes, nombres e ID de política."},
    ...
    {"ar_address_setup_desc", "Vuelve a Inicio para completar primero la configuración de tu dirección AR."},
    {"ar_address_setup_required", "Se requiere configurar la dirección AR"},
    {"ar_preparation_address_notice", "Distintas billeteras pueden generar direcciones AR diferentes a partir de la misma frase semilla. Después de conectar una billetera de software, asegúrate de que su dirección coincida con la de este dispositivo."},
    {"ar_preparation_power_notice", "Comienza con al menos un 80% de batería y mantén la alimentación USB conectada durante todo el proceso. Puede tardar unos 10 minutos."},
    {"ar_preparation_title", "Preparación de la dirección AR"},
    ...
    {"change_entropy_dice_detail_desc_1", "Necesitas lanzar los dados al menos #F5870A 50# #F5870A veces# para generar una frase de recuperación, y se recomienda lanzarlos más de #F5870A 99# #F5870A veces# para obtener suficiente aleatoriedad."},
    ...
    {"firmware_check_desc", "Mantén tu firmware actualizado para disfrutar de las últimas mejoras, funciones y una mejor experiencia."},
    {"firmware_check_qr_title", "Comprobar firmware"},
    {"firmware_check_step1", "Visita nuestro sitio web y consulta la última versión del firmware en el registro de cambios."},
    {"firmware_check_step2", "Compárala con la versión del firmware de tu dispositivo."},
    {"firmware_check_step3", "Asegúrate de que tu firmware esté actualizado."},
    {"firmware_check_title", "Comprobar versión del firmware"},
    {"firmware_check_up_to_date", "Mi firmware está actualizado"},
    {"firmware_check_update", "Actualizar firmware"},
    {"firmware_check_version_fmt", "Versión de firmware: %s"},
    ...
    {"firmware_update_desc", "Actualiza el firmware para nuevas funciones."},
    ...
    {"firmware_update_recommended_desc", "Actualiza tu firmware a la última versión para mejorar la seguridad, las funciones y la compatibilidad."},
    {"firmware_update_recommended_title", "Actualización recomendada"},
    ...
    {"firmware_update_skip_fmt", "Omitir (%ds)"},
    ...
    {"import_wallet_phrase_desc", "Introduce tu frase semilla en el orden correcto."},
    ...
    {"iota_gas_sponsor_notice", "La comisión de la transacción será pagada por otra cuenta."},
    {"iota_max_amount_notice", "Esto transfiere el objeto de moneda completo. El importe final depende de la comisión de la transacción y no puede mostrarse antes de la ejecución."},
    {"iota_message_raw_data_notice", "El mensaje no se puede mostrar como texto. Revise cuidadosamente los datos sin procesar antes de firmar."},
    {"iota_unknown_transaction_desc", "No se reconoce como una transferencia o staking estándar. Revise cuidadosamente los datos sin procesar antes de firmar."},
    {"iota_unknown_transaction_title", "Transacción desconocida"},
    ...
    {"seed_backup_confirm_check", "Copia de seguridad guardada."},
    {"seed_backup_confirm_desc", "Comprueba las palabras y su orden. No podrás verlas de nuevo después."},
    {"seed_backup_confirm_title", "Confirma tu copia de seguridad"},
    ...
    {"seed_phrase_privacy_notice", "Mantenla segura y privada."},
    ...
    {"single_backup_notice_item1", "La billetera de hardware es solo para uso personal. Nunca compartas tu dispositivo con otras personas."},
    {"single_backup_notice_item2", "Haz una copia de seguridad de tu frase semilla. Después no podrás verla ni exportarla."},
    {"single_backup_notice_item3", "Nunca compartas tu frase semilla. Da acceso a tus activos."},
    {"single_backup_notice_page_desc", "Lee atentamente estas notas de seguridad importantes antes de continuar."},
    {"single_backup_notice_page_title", "Aviso"},
    ...
    {"single_phrase_desc", "Escribe tu frase semilla en el orden correcto."},
    ...
    {"solana_blind_sign_title", "Firma ciega"},
    ...
    {"system_settings_wipe_device_wipe_alert_desc", "Todas las billeteras y datos de este dispositivo se eliminarán de forma permanente. Esta acción no se puede deshacer."},
    {"system_settings_wipe_device_wipe_backup_desc", "Asegúrate de que tu frase de recuperación esté respaldada de forma segura. Da acceso a tu billetera y activos."},
    {"system_settings_wipe_device_wipe_button", "Borrar dispositivo ahora"},
    {"system_settings_wipe_device_wipe_desc", "Todos los datos de este dispositivo, incluidas tus billeteras, se eliminarán de forma permanente."},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "アカウント"},
    {"ada_multi_assets_warning", "ネイティブアセットを含みます。数量、名前、ポリシーIDを確認してください。"},
    {"ada_proposals_tx_notice", "投票提案に関連するトランザクションに現在署名していることに注意してください。"},
    {"ar_address_setup_desc", "まずホームに戻り、ARアドレスの設定を完了してください。"},
    {"ar_address_setup_required", "ARアドレスの設定が必要です"},
    {"ar_preparation_address_notice", "同じシードフレーズでも、ウォレットによって異なるARアドレスが生成される場合があります。ソフトウェアウォレットに接続した後、そのアドレスが本デバイスのアドレスと一致することを確認してください。"},
    {"ar_preparation_power_notice", "バッテリー残量が80%以上の状態で開始し、処理中はUSB電源を接続したままにしてください。約10分かかる場合があります。"},
    {"ar_preparation_title", "ARアドレスの準備"},
    ...
    {"change_entropy_dice_detail_desc_1", "シードフレーズを生成するには、少なくとも #F5870A 50##F5870A 回#サイコロを振る必要があります。また、十分なランダム性を確保するためには、#F5870A 99##F5870A 回#を超えて振ることが推奨されています。"},
    ...
    {"firmware_check_desc", "最新の改善や機能を利用して、より良い体験をするためにファームウェアを最新の状態に保ってください."},
    {"firmware_check_qr_title", "最新のファームウェアを確認"},
    {"firmware_check_step1", "ウェブサイトにアクセスし、変更履歴で最新のファームウェアバージョンを確認してください."},
    {"firmware_check_step2", "デバイスのファームウェアバージョンと比較してください."},
    {"firmware_check_step3", "ファームウェアが最新であることを確認してください."},
    {"firmware_check_title", "ファームウェアバージョンを確認"},
    {"firmware_check_up_to_date", "ファームウェアは最新です"},
    {"firmware_check_update", "ファームウェアを更新"},
    {"firmware_check_version_fmt", "ファームウェアバージョン: %s"},
    ...
    {"firmware_update_desc", "新機能を使うには、ファームウェアを更新してください"},
    ...
    {"firmware_update_recommended_desc", "セキュリティ、機能、互換性を向上させるためにファームウェアを最新バージョンに更新してください."},
    {"firmware_update_recommended_title", "アップデートを推奨"},
    ...
    {"firmware_update_skip_fmt", "スキップ (%ds)"},
    ...
    {"import_wallet_phrase_desc", "シードフレーズを正しい順序で入力してください."},
    ...
    {"iota_gas_sponsor_notice", "このトランザクション手数料は別のアカウントが負担します。"},
    {"iota_max_amount_notice", "これはコインオブジェクト全体を転送します。最終的な金額はトランザクション手数料によって決まるため、実行前には表示できません。"},
    {"iota_message_raw_data_notice", "メッセージをテキストとして表示できません。署名前に生データを慎重に確認してください。"},
    {"iota_unknown_transaction_desc", "標準的な送金またはステーキングとして認識されません。署名前に生データを慎重に確認してください。"},
    {"iota_unknown_transaction_title", "不明なトランザクション"},
    ...
    {"seed_backup_confirm_check", "安全にバックアップしました."},
    {"seed_backup_confirm_desc", "すべての単語と順序を確認してください。設定後は再表示できません."},
    {"seed_backup_confirm_title", "バックアップを確認"},
    ...
    {"seed_phrase_privacy_notice", "安全にバックアップし、秘密にしてください."},
    ...
    {"single_backup_notice_item1", "ハードウェアウォレットは個人使用専用です。デバイスを他人と共有しないでください."},
    {"single_backup_notice_item2", "シードフレーズをバックアップしてください。後から表示またはエクスポートすることはできません."},
    {"single_backup_notice_item3", "シードフレーズを決して共有しないでください。シードフレーズで資産にアクセスできます."},
    {"single_backup_notice_page_desc", "続行する前に、これらの重要な安全上の注意をよくお読みください."},
    {"single_backup_notice_page_title", "お知らせ"},
    ...
    {"single_phrase_desc", "シードフレーズを正しい順序で書き留めてください."},
    ...
    {"solana_blind_sign_title", "ブラインド署名"},
    ...
    {"system_settings_wipe_device_wipe_alert_desc", "このデバイス上のすべてのウォレットとデータは永久に削除されます。この操作は元に戻せません."},
    {"system_settings_wipe_device_wipe_backup_desc", "シードフレーズが安全にバックアップされていることを確認してください。ウォレットと資産にアクセスできる大切な情報です."},
    {"system_settings_wipe_device_wipe_button", "デバイスを今すぐ削除する"},
    {"system_settings_wipe_device_wipe_desc", "このデバイス上のすべてのデータ(ウォレットを含む)が永久に削除されます."},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "계정 전환"},
    {"ada_multi_assets_warning", "네이티브 자산이 포함되어 있습니다. 수량, 이름, 정책 ID를 확인하세요."},
    {"ada_proposals_tx_notice", "현재 투표 제안과 관련된 거래에 서명하고 있습니다."},
    {"ar_address_setup_desc", "먼저 홈으로 돌아가 AR 주소 설정을 완료해 주세요."},
    {"ar_address_setup_required", "AR 주소 설정 필요"},
    {"ar_preparation_address_notice", "지갑에 따라 동일한 시드 문구에서도 서로 다른 AR 주소가 생성될 수 있습니다. 소프트웨어 지갑에 연결한 후 해당 주소가 이 기기의 주소와 일치하는지 확인하세요."},
    {"ar_preparation_power_notice", "배터리가 80% 이상 충전된 상태에서 시작하고, 전체 과정 동안 USB 전원 연결을 유지하세요. 약 10분이 소요될 수 있습니다."},
    {"ar_preparation_title", "AR 주소 준비"},
    ...
    {"change_entropy_dice_detail_desc_1", "주사위를 최소 #F5870A 50##F5870A 번# 던져서 시드 구문 세트를 생성해야 합니다. 충분한 무작위성을 보장하기 위해 #F5870A 99##F5870A 회#보다 더 많이 던지는 것이 좋습니다."},
    ...
    {"firmware_check_desc", "최신 개선 사항과 기능을 이용하고 더 나은 경험을 위해 펌웨어를 최신 상태로 유지하세요."},
    {"firmware_check_qr_title", "최신 펌웨어 확인"},
    {"firmware_check_step1", "웹사이트를 방문하여 변경 로그에서 최신 펌웨어 버전을 확인하세요."},
    {"firmware_check_step2", "장치의 펌웨어 버전과 비교하세요."},
    {"firmware_check_step3", "펌웨어가 최신 상태인지 확인하세요."},
    {"firmware_check_title", "펌웨어 버전 확인"},
    {"firmware_check_up_to_date", "펌웨어가 최신입니다"},
    {"firmware_check_update", "펌웨어 업데이트"},
    {"firmware_check_version_fmt", "펌웨어 버전: %s"},
    ...
    {"firmware_update_desc", "새 기능을 사용하려면 펌웨어를 업데이트하세요!"},
    ...
    {"firmware_update_recommended_desc", "보안, 기능 및 호환성 향상을 위해 펌웨어를 최신 버전으로 업데이트하세요."},
    {"firmware_update_recommended_title", "업데이트 권장"},
    ...
    {"firmware_update_skip_fmt", "건너뛰기 (%ds)"},
    ...
    {"import_wallet_phrase_desc", "시드 문구를 올바른 순서로 입력하세요."},
    ...
    {"iota_gas_sponsor_notice", "이 거래 수수료는 다른 계정에서 지불됩니다."},
    {"iota_max_amount_notice", "이 작업은 코인 객체 전체를 전송합니다. 최종 금액은 거래 수수료에 따라 달라지므로 실행 전에 표시할 수 없습니다."},
    {"iota_message_raw_data_notice", "메시지를 텍스트로 표시할 수 없습니다. 서명하기 전에 원시 데이터를 주의 깊게 검토하세요."},
    {"iota_unknown_transaction_desc", "표준 전송 또는 스테이킹으로 인식되지 않습니다. 서명하기 전에 원시 데이터를 주의 깊게 검토하세요."},
    {"iota_unknown_transaction_title", "알 수 없는 거래"},
    {"language_desc", "언어 선택"},
    ...
    {"seed_backup_confirm_check", "안전하게 백업했습니다."},
    {"seed_backup_confirm_desc", "모든 단어와 순서를 확인하세요. 설정 후에는 다시 볼 수 없습니다."},
    {"seed_backup_confirm_title", "백업 확인"},
    ...
    {"seed_phrase_privacy_notice", "안전하게 백업하고 비공개로 보관하세요."},
    ...
    {"single_backup_notice_item1", "하드웨어 지갑은 개인용으로만 사용하세요. 기기를 다른 사람과 절대 공유하지 마세요."},
    {"single_backup_notice_item2", "시드 구문을 백업하세요. 나중에 보거나 내보낼 수 없습니다."},
    {"single_backup_notice_item3", "시드 구문을 절대 공유하지 마세요. 시드 구문으로 자산에 접근할 수 있습니다."},
    {"single_backup_notice_page_desc", "계속하기 전에 다음 중요한 안전 수칙을 주의 깊게 읽으세요."},
    {"single_backup_notice_page_title", "안내"},
    ...
    {"single_phrase_desc", "시드 문구를 올바른 순서로 적어 두세요."},
    ...
    {"solana_blind_sign_title", "블라인드 서명"},
    ...
    {"system_settings_wipe_device_wipe_alert_desc", "이 장치의 모든 지갑과 데이터가 영구적으로 삭제됩니다. 이 작업은 취소할 수 없습니다."},
    {"system_settings_wipe_device_wipe_backup_desc", "시드 구문을 안전하게 백업했는지 확인하세요. 시드 구문으로 지갑과 자산에 접근할 수 있습니다."},
    {"system_settings_wipe_device_wipe_button", "지금 장치 지우기"},
    {"system_settings_wipe_device_wipe_desc", "이 장치의 모든 데이터와 지갑이 영구적으로 삭제됩니다."},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"Pending", "В ожидании"},
    {"Policy", "Политика"},
    {"PreparingArAddress", "Подготовка AR-адреса..."},
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "Счет"},
    {"ada_multi_assets_warning", "Есть нативные активы. Проверьте суммы, названия и ID политик."},
    {"ada_proposals_tx_notice", "Обратите внимание, вы сейчас подписываете транзакцию, связанную с предложением по голосованию."},
    {"ar_address_setup_desc", "Вернитесь на главный экран и сначала завершите настройку AR-адреса."},
    {"ar_address_setup_required", "Требуется настройка AR-адреса"},
    {"ar_preparation_address_notice", "Разные кошельки могут создавать разные AR-адреса из одной и той же сид-фразы. После подключения к программному кошельку убедитесь, что его адрес совпадает с адресом на этом устройстве."},
    {"ar_preparation_power_notice", "Перед началом убедитесь, что заряд батареи составляет не менее 80%, и не отключайте питание по USB на протяжении всего процесса. Это может занять около 10 минут."},
    {"ar_preparation_title", "Подготовка AR-адреса"},
    ...
    {"change_entropy_dice_detail_desc_1", "Вам необходимо бросить кубик как минимум #F5870A 50# #F5870A раз#, чтобы сгенерировать сид-фразу. Рекомендуется бросить кубик больше #F5870A 99# #F5870A раз# для достаточной случайности."},
    ...
    {"firmware_check_desc", "Поддерживайте прошивку в актуальном состоянии, чтобы пользоваться последними улучшениями и функциями."},
    {"firmware_check_qr_title", "Проверить прошивку"},
    {"firmware_check_step1", "Посетите наш сайт и проверьте последнюю версию прошивки в журнале изменений."},
    {"firmware_check_step2", "Сравните её с версией прошивки вашего устройства."},
    {"firmware_check_step3", "Убедитесь, что ваша прошивка обновлена."},
    {"firmware_check_title", "Проверка версии прошивки"},
    {"firmware_check_up_to_date", "Моя прошивка обновлена"},
    {"firmware_check_update", "Обновить прошивку"},
    {"firmware_check_version_fmt", "Версия прошивки: %s"},
    ...
    {"firmware_update_desc", "Обновите прошивку для новых функций."},
    ...
    {"firmware_update_recommended_desc", "Обновите прошивку до последней версии для повышения безопасности, добавления новых функций и совместимости."},
    {"firmware_update_recommended_title", "Рекомендуется обновить"},
    ...
    {"firmware_update_skip_fmt", "Пропустить (%ds)"},
    ...
    {"import_wallet_phrase_desc", "Введите сид-фразу в правильном порядке."},
    ...
    {"iota_gas_sponsor_notice", "Комиссия за транзакцию будет оплачена другим аккаунтом."},
    {"iota_max_amount_notice", "Это приведет к передаче всего объекта монеты. Итоговая сумма зависит от комиссии за транзакцию и не может быть показана до выполнения."},
    {"iota_message_raw_data_notice", "Сообщение невозможно отобразить как текст. Внимательно проверьте необработанные данные перед подписанием."},
    {"iota_unknown_transaction_desc", "Не распознана как стандартный перевод или стейкинг. Внимательно проверьте необработанные данные перед подписанием."},
    {"iota_unknown_transaction_title", "Неизвестная транзакция"},
    ...
    {"seed_backup_confirm_check", "Резервная копия сохранена."},
    {"seed_backup_confirm_desc", "Проверьте слова и их порядок. После настройки их нельзя будет увидеть снова."},
    {"seed_backup_confirm_title", "Подтвердите резервную копию"},
    ...
    {"seed_phrase_privacy_notice", "Храните резервную копию в тайне."},
    ...
    {"single_backup_notice_item1", "Аппаратный кошелек предназначен только для личного использования. Никогда не передавайте свое устройство другим."},
    {"single_backup_notice_item2", "Сделайте резервную копию сид-фразы. Позже ее нельзя будет просмотреть или экспортировать."},
    {"single_backup_notice_item3", "Никогда не сообщайте свою сид-фразу. Она дает доступ к вашим активам."},
    {"single_backup_notice_page_desc", "Пожалуйста, внимательно прочитайте эти важные правила безопасности, прежде чем продолжить."},
    {"single_backup_notice_page_title", "Уведомление"},
    ...
    {"single_phrase_desc", "Запишите сид-фразу в правильном порядке."},
    ...
    {"solana_blind_sign_title", "Слепая подпись"},
    ...
    {"system_settings_wipe_device_wipe_alert_desc", "Все кошельки и данные на этом устройстве будут удалены без возможности восстановления. Это действие нельзя отменить."},
    {"system_settings_wipe_device_wipe_backup_desc", "Убедитесь, что ваша сид-фраза надежно сохранена. Она дает доступ к вашему кошельку и активам."},
    {"system_settings_wipe_device_wipe_button", "Сбросить"},
    {"system_settings_wipe_device_wipe_desc", "Все данные на этом устройстве, включая ваши кошельки, будут удалены без возможности восстановления."},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"about_terms_website_url", "https://keyst.one/terms"},
    {"account_head", "账户"},
    {"ada_multi_assets_warning", "此交易包含原生资产，请核对数量、名称和策略 ID。"},
    {"ada_proposals_tx_notice", "请注意，您目前正在签署与投票提案相关的交易。"},
    {"ar_address_setup_desc", "请先返回首页完成 AR 地址设置。"},
    {"ar_address_setup_required", "需要设置 AR 地址"},
    {"ar_preparation_address_notice", "不同钱包可能会使用同一组助记词生成不同的 AR 地址。连接软件钱包后，请确认其地址与本设备上显示的地址一致。"},
    {"ar_preparation_power_notice", "开始前请确保电量至少为 80%，并在整个过程中保持 USB 供电连接。此过程可能需要约 10 分钟。"},
    {"ar_preparation_title", "AR 地址准备"},
    {"auto_shutdown", "自动关闭"},
    ...
    {"change_entropy_dice_detail_desc_1", "您需要至少掷 #F5870A 50# #F5870A 次#骰子来生成一组助记词。建议掷超过 #F5870A 99# #F5870A 次#，以获得足够的随机性。"},
    ...
    {"firmware_check_desc", "保持固件为最新版本,享受最新改进和功能,并获得更好的使用体验."},
    {"firmware_check_qr_title", "检查最新固件"},
    {"firmware_check_step1", "访问我们的网站,在更新日志中查看最新的固件版本."},
    {"firmware_check_step2", "将其与设备的固件版本进行比较."},
    {"firmware_check_step3", "确保您的固件为最新版本."},
    {"firmware_check_title", "固件版本检查"},
    {"firmware_check_up_to_date", "我的固件已是最新版本"},
    {"firmware_check_update", "更新固件"},
    {"firmware_check_version_fmt", "固件版本: %s"},
    ...
    {"firmware_update_desc", "体验最新功能，请更新固件!"},
    ...
    {"firmware_update_recommended_desc", "将固件更新到最新版本,以提高安全性,获得更多功能并改善兼容性."},
    {"firmware_update_recommended_title", "建议更新"},
    ...
    {"firmware_update_skip_fmt", "跳过 (%ds)"},
    ...
    {"import_wallet_phrase_desc", "请按正确顺序输入您的助记词."},
    ...
    {"iota_gas_sponsor_notice", "本次交易的手续费将由另一个账户支付。"},
    {"iota_max_amount_notice", "这将转移整个 Coin 对象。最终金额取决于交易手续费，无法在执行前显示。"},
    {"iota_message_raw_data_notice", "消息无法以文本形式显示。签名前请仔细检查原始数据。"},
    {"iota_unknown_transaction_desc", "未识别为标准转账或质押交易。签名之前请仔细检查原始数据。"},
    {"iota_unknown_transaction_title", "未知交易"},
    ...
    {"seed_backup_confirm_check", "我已安全地完成备份。"},
    {"seed_backup_confirm_desc", "请确认所有单词及顺序。设置后将无法再次查看。"},
    {"seed_backup_confirm_title", "确认备份"},
    ...
    {"seed_phrase_privacy_notice", "请安全备份并保密."},
    ...
    {"single_backup_notice_item1", "硬件钱包仅供个人使用。切勿将您的设备交给他人使用。"},
    {"single_backup_notice_item2", "请备份您的助记词。之后将无法查看或导出。"},
    {"single_backup_notice_item3", "切勿分享您的助记词。它可以访问您的资产。"},
    {"single_backup_notice_page_desc", "继续之前，请仔细阅读这些重要的安全提示。"},
    {"single_backup_notice_page_title", "注意"},
    ...
    {"single_phrase_desc", "请按正确顺序写下您的助记词."},
    ...
    {"system_settings_wipe_device_wipe_alert_desc", "此设备上的所有钱包和数据都将被永久删除.此操作无法撤销."},
    {"system_settings_wipe_device_wipe_backup_desc", "请确保您的助记词已安全备份。它可以访问您的钱包和资产。"},
    {"system_settings_wipe_device_wipe_button", "立即擦除设备"},
    {"system_settings_wipe_device_wipe_desc", "此设备上的所有数据,包括您的钱包,都将被永久删除."},
