...
static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"derivation_path_sol_1_desc", "Multiple accounts, Commonly used by Solflare."},
    {"derivation_path_sol_2_desc", "A single Solana account, Used by Sollet and MathWallet."},
    {"derivation_path_sol_3_desc", "Extra layers, Utilized by Phantom and Exodus."},
    ...
    {"shamir_phrase_confirm_title", "Confirm Your Share"},
