...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"firmware_update_desc1", "키스톤의 배터리 잔량이 최소 20% 이상 남아 있는지 확인합니다."},
    {"firmware_update_desc2", "컴퓨터나 스마트폰을 사용하여 키스톤의 펌웨어 업데이트 페이지로 이동합니다."},
    ...
    {"wallet_phrase_12words", "12 단어"},
    {"wallet_phrase_18words", "18 단어"},
    {"wallet_phrase_20words", "20 단어"},
    {"wallet_phrase_24words", "24 단어"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"connect_wallet_desc", "请使用电脑或者手机访问下方的链接,以获取有关Keystone如何连接软件钱包的教程。"},
    ...
    {"passphrase_learn_more_desc2", "每个唯一的密码子都会产生不同的钱包。密语不同,则生成的密语钱包不同;"},
