...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"unlock_device_attempts_left_plural_times_fmt", "Falsches Passwort, %d Versuche restlich"},
    {"unlock_device_attempts_left_singular_times_fmt", "Falsches Passwort, %d Versuch restlich"},
    ...
    {"wallet_profile_add_multi_wallet", "MultiSig-Wallet hinzufügen"},
