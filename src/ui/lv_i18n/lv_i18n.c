...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"passphrase_enabled_desc", "Select the preferred method for backing up your seed phrase."},
    ...
    {"passphrase_warning_text", "Passphrase Enabled. Both Seed Phrase and Passphrase required. Forget one"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"passphrase_enabled_desc", "Wählen Sie die bevorzugte Methode zum Sichern Ihrer Seed-Phrase."},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"passphrase_enabled_desc", "Selecciona el método preferido para respaldar tu frase semilla."},
    ...
    {"passphrase_warning_text", " активы потеряны.\""},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"passphrase_enabled_desc", "シードフレーズのバックアップ方法を選択してください."},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"passphrase_enabled_desc", "시드 구문을 백업할 선호하는 방법을 선택하세요."},
    ...
    {"passphrase_warning_text", "Пароль включен. Требуется как семенная фраза"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"passphrase_enabled_desc", "Выберите предпочтительный способ резервного копирования вашей семенной фразы."},
    ...
    {"passphrase_warning_text", " \"assets lost."},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"passphrase_enabled_desc", "选择备份种子短语的首选方法。"},
    ...
    {"passphrase_warning_text", " так и ключевые слова. Забудь об одном"},
