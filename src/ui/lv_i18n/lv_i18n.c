...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"derivation_path_select_avax", "Select the derivation path you’d like to use for AVAX"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"derivation_path_select_avax", "Wählen Sie den Ableitungspfad aus, den Sie für AVAX verwenden möchten."},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"derivation_path_select_avax", "Seleccione la ruta de derivación que desee utilizar para AVAX"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"derivation_path_select_avax", "AVAXで使用する派生経路を選択してください."},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"derivation_path_select_avax", "AVAX에 사용할 파생 경로를 선택하십시오"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"derivation_path_select_avax", "Выберите путь вывода AVAX, который вы хотите использовать"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"derivation_path_select_avax", "选择要用于 AVAX 的衍生路径"},
