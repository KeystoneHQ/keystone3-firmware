...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"chain_path_avax_c_desc", "Multiple accounts, commonly used by Eternl, Yoroi, Daedalus."},
    {"chain_path_avax_x_p_desc", "A single Solana account, Used by Sollet and MathWallet."},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"chain_path_avax_c_desc", "Múltiples cuentas, comúnmente utilizadas por Eternl, Yoroi, Daedalus."},
    {"chain_path_avax_x_p_desc", "Ein einzelnes Solana-Konto, das von Sollet und MathWallet verwendet wird"},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"chain_path_avax_c_desc", "常见用于Eternl、Yoroi、Daedalus。\" "},
    {"chain_path_avax_x_p_desc", "Una sola cuenta de Solana, utilizada por Sollet y MathWallet."},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"chain_path_avax_c_desc", "Mehrere Konten, die häufig von Eternl, Yoroi und Daedalus verwendet werden."},
    {"chain_path_avax_x_p_desc", "SolletとMathWalletで使用される単一のSolanaアカウント."},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"chain_path_avax_c_desc", "이트널, 요로이, 데달루스에서 널리 사용되는 다중 계정."},
    {"chain_path_avax_x_p_desc", "Solana 단일 계정, Sollet 및 MathWallet에서 사용됨."},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"chain_path_avax_c_desc", "Множественные аккаунты, часто используемые Eternl, Yoroi, Daedalus."},
    {"chain_path_avax_x_p_desc", "Один счет Solana, используемый Sollet и MathWallet."},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"chain_path_avax_c_desc", " \"多个账户"},
    {"chain_path_avax_x_p_desc", "单一的Solana账户,由Sollet和MathWallet使用"},
    {"change_entropy", "更改熵"},
