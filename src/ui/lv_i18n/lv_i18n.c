...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Add up to1 passphrase multisig wallets"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Fügen Sie bis zu 4 Multisig-Wallets hinzu, einschließlich Testnetz und Hauptnetz."},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Agrega hasta 4 billeteras multisig, incluyendo la red de prueba y la red principal."},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "最大4つのマルチシグウォレットを追加することができます.テストネットとメインネットの両方が対応しています."},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "테스트넷과 메인넷을 포함하여 최대 4개의 다중 서명 지갑을 추가 가능합니다"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "Добавьте до 4 кошельков с мультиподписью, включая тестовую сеть и основную сеть."},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"manage_multi_wallet_passphrase_add_limit_desc", "最多添加 4 个多重签名钱包,包括测试网和主网."},
