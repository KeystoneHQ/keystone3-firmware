...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"shamir_20word_coin_notice", "Some coins (ZEC) require 33-word Shamir shares. To use them, create a new wallet with 33-word shares."},
    {"shamir_20words_desc", "Supports most coins"},
    {"shamir_33words_desc", "Also supports ZEC"},
