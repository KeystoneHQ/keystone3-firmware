...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"private_qr_mode_security_notice_desc", "To protect your privacy, the QR code is encrypted. You’ll need to enter a PIN in the software wallet to decrypt it. Your device will display this PIN next; please keep it confidential to ensure your data remains secure."},
    ...
    {"xmr_primary_address_title", "What is a Primary address?"},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"private_qr_mode_security_notice_desc", ""},
    ...
    {"xmr_primary_address_desc", ""},
    {"xmr_primary_address_link", "https://keyst.one/xmr/account"},
    {"xmr_primary_address_title", ""},
