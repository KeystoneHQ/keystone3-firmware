...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"unknown_transaction_desc", "All data in this transaction are customized and can't be decoded currently."},
    {"unknown_transaction_title", "No Transaction Details"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"unknown_transaction_desc", "이 거래의 모든 데이터는 맞춤 설정되어 있으며 현재 해독할 수 없습니다"},
    {"unknown_transaction_title", "거래 내역 없음"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"unknown_transaction_desc", "Все данные в этой транзакции настроены индивидуально и в настоящее время не могут быть расшифрованы."},
    {"unknown_transaction_title", "Нет данных о транзакции"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"unknown_transaction_desc", "该交易中的所有数据均为定制,当前无法解码"},
    {"unknown_transaction_title", "无交易详情"},
    {"unlock_device", "解锁设备"},
