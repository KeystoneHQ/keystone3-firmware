...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"connect_yoroi_desc", ""},
    {"connect_yoroi_link", ""},
    {"connect_yoroi_qr_link", ""},
    {"connect_yoroi_qr_title", ""},
    {"connect_yoroi_title", ""},
    ...
    {"device_settings_connection_sub_title1", "USB로 데이터 전송"},
    {"device_settings_connection_title1", "연결"},
    ...
    {"firmware_update_deny_input_password_title", "비밀번호를 입력해주세요"},
    ...
    {"firmware_update_sd_updating_title", "업데이트중"},
    {"firmware_update_title", "펌웨어 업데이트"},
    {"firmware_update_updating_desc", "약 5분 소요"},
    {"firmware_update_updating_title", "업데이트중"},
    ...
    {"firmware_update_usb_low_title", "배터리 부족"},
    {"firmware_update_usb_qr_link", "https://keyst.one/webusb"},
    ...
    {"forgot_password_reset_passcode_intro_button", "암호 재설정"},
    ...
    {"import_wallet_duplicated_share_title", "중복 공유"},
    {"import_wallet_invalid_phrase_desc", "입력한 구문이 잘못되었습니다. 백업을 확인하고 다시 시도하십시오"},
    {"import_wallet_invalid_phrase_title", "잘못된 시드 구문"},
    {"import_wallet_invalid_phrase_title_desc", "입력한 시드 구문이 잘못되었습니다. 백업을 다시 확인하고 다시 시도하십시오."},
    ...
    {"import_wallet_ssb_notbelong_title", "공유 불일치"},
    ...
    {"passphrase_learn_more_qr_link", "https://keyst.one/t/3rd/passphrase"},
    {"passphrase_learn_more_qr_title", "패스프레이즈란?"},
    ...
    {"system_settings_wipe_device_wipe_alert_title", "장치 초기화"},
    ...
    {"unlock_device_fingerprint_pin_error1_desc", "지문을 확인할 수 없습니다"},
    {"unlock_device_fingerprint_pin_error1_title", "재시도"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"connect_yearn_t", "教程"},
    {"connect_yearn_title", "Yearn"},
    {"connect_yoroi_desc", "请使用电脑或者手机访问下方的链接，以获取有关Keystone如何连接软件钱包的教程。"},
    {"connect_yoroi_link", "https://keyst.one/t/3rd/yoroi"},
    {"connect_yoroi_qr_link", "https://keyst.one/t/3rd/yoroi"},
    {"connect_yoroi_qr_title", "Yoroi 钱包"},
    {"connect_yoroi_title", "Yoroi 钱包"},
