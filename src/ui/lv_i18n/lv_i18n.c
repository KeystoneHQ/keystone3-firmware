...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"nft_transfer_failed_desc", "Please retry the transfer and do not unplug the USB cable during transfer."},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"nft_transfer_failed_desc", "Bitte versuchen Sie die Übertragung erneut und ziehen Sie das USB-Kabel während der Übertragung nicht ab"},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"nft_transfer_failed_desc", "Por favor,intente la transferencia nuevamente y no desconecte el cable USB durante la transferencia"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"nft_transfer_failed_desc", "転送を再試行し、転送中はUSBケーブルを抜かないでください"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"nft_transfer_failed_desc", "전송을 다시 시도하고 전송 중에는 USB 케이블을 분리하지 마십시오"},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"nft_transfer_failed_desc", "Пожалуйста,повторите передачу и не отключайте USB-кабель во время передачи"},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"nft_transfer_failed_desc", "请重试传输并且在传输过程中不要拔掉USB电缆"},
