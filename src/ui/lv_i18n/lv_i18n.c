...
static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"about_info_verify_firmware_step3", "Tap the #F5870A Show Checksum# button below and compare the string with the one you got in the second step."},
    ...
    {"derivation_path_btc_1_desc", "Modern format, lower fees, starts with \"bc1q.\""},
    ...
    {"derivation_path_eth_standard_desc", ""},
    ...
    {"derivation_path_select_eth", "Default, follows BIP44, widely used."},
    ...
    {"device_settings_connection_desc1", "When enabled, the USB port can only be used for battery charging purposes"},
    {"device_settings_connection_sub_title1", "Air-Gap Mode"},
    ...
    {"wallet_profile_single-sign_title", "Single-Sig Wallet"},
