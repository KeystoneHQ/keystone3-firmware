...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"manage_import_wallet_notice_desc2", "Важно надежно сохранить резервную копию конфигурации кошелька, иначе вы рискуете потерять активы. Измененная или несоответствующая информация также может привести к потерям. Всегда проверяйте и защищайте данные кошелька, чтобы избежать несоответствий."},
