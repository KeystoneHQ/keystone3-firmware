...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"rust_error_bitcoin_no_my_inputs", "Inkongruente Transaktion"},
    {"rust_error_bitcoin_no_my_inputs_desc", "Die Transaktion gehört nicht zur aktuellen Brieftasche. Bitte überprüfen Sie die Transaktionsinformationen."},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"about_info_result_export_failed_desc_no_space", "Por favor, asegúrese de que su tarjeta MicroSD tenga suficiente memoria."},
    {"about_info_result_export_successful", "Exportación exitosa"},
    {"about_info_result_export_successful_desc", "El registro de su sistema ha sido exportado correctamente a la tarjeta MicroSD"},
    {"about_info_serial_number", "Número de serie"},
    {"about_info_verify_checksum_desc", "Por favor verifique si la información anterior coincide con la página web. Si no coincide, significa que su firmware podría haber sido manipulado. Por favor, deje de usarlo inmediatamente."},
    ...
    {"about_info_verify_firmware_step1", "Vaya al repositorio de GitHub de Keystone de código abierto y siga las instrucciones para construir su firmware y obtener el checksum"},
    {"about_info_verify_firmware_step2", "Haga clic en el botón #F5870A Checksum# junto a la descarga del firmware"},
    ...
    {"about_terms_contact_us_desc", "Si tiene alguna pregunta o inquietud, por favor envíenos un correo electrónico a support@keyst.one"},
    {"about_terms_desc", "Para acceder a la versión completa de los TÉRMINOS DE USO, visite el siguiente enlace:"},
    ...
    {"about_terms_discontinuance_service_desc", "Podemos modificar o interrumpir nuestros servicios. Recuerde hacer una copia de seguridad de su frase semilla para acceder a sus criptomonedas"},
    {"about_terms_eligibility", "Elegibilidad"},
    {"about_terms_eligibility_desc", "Debe tener 18 años o más para acceder y usar nuestros Productos o Servicios"},
    ...
    {"about_terms_no_sensitive_information_desc", "No almacenamos información delicada como contraseñas o frases semilla. Mantenga sus credenciales seguras"},
    {"about_terms_ownership", "Propiedad y derechos de propiedad"},
    {"about_terms_ownership_desc", "Usted es responsable de sus acciones al usar los Productos y Servicios"},
    ...
    {"change_entropy_desc", "Seleccione la Entropía que desee utilizar para crear carteras"},
    {"change_entropy_dice_desc", "Cree su frase semilla con números aleatorios generados al lanzar dados"},
    {"change_entropy_dice_detail_desc_1", "Necesita rodar al menos 50 veces #F5870A# para generar una frase semilla, y se recomienda rodar más de 99 veces #F5870A# para obtener suficiente aleatoriedad."},
    {"change_entropy_dice_detail_desc_2", "Recomendamos que use dados de casino para aumentar la entropía de cada lanzamiento"},
    ...
    {"change_entropy_system_desc", "Cree su frase semilla a partir del generador de números aleatorios verdaderamente aleatorio SEs keystone"},
    {"change_entropy_system_subtitle", "Usar la entropía de las SEs de Keystone"},
    {"change_passcode_mid_btn", "Ingrese el código de acceso"},
    {"change_passcode_reset_success_desc", "Su código de acceso ha sido restablecido correctamente"},
    ...
    {"change_passcode_warning_desc", "Si lo olvida, tendrá que verificar la frase semilla de esta billetera para restablecer el código de acceso."},
    {"change_passcode_warning_title", "Recuerde su código de acceso"},
    ...
    {"connect_fewcha_link", "https://keyst.one/t/3rd/fewcha"},
    {"connect_fewcha_title", "Fewcha(extensión)"},
    ...
    {"connect_safe_link2", "https://keyst.one/t/3rd/safem"},
    {"connect_safe_title", "Safe (Web)"},
    {"connect_safe_title2", "Safe (Móvil)"},
    {"connect_solflare_link", "https://keyst.one/t/3rd/solflare"},
    {"connect_solflare_title", "Solflare"},
    {"connect_sparrow_link", "https://keyst.one/t/3rd/sparrow"},
    {"connect_sparrow_multisig_link", "https://keyst.one/t/3rd/Multisig/sparrow"},
    ...
    {"connect_unisat_link", "https://keyst.one/t/3rd/unisat"},
    {"connect_unisat_title", "UniSat"},
    {"connect_wallet_ada_step1", "Seleccione las cuentas que desee importar en su billetera de %s"},
    ...
    {"connect_wallet_key_request_fmt", "%s Wallet quiere obtener su clave pública en su Keystone:"},
    {"connect_wallet_keystone_hint", "Seleccione las redes que le gustaría gestionar en la billetera de software"},
    {"connect_wallet_scan", "Escanee el código QR con su billetera de software"},
    {"connect_wallet_select_network", "Seleccionar red"},
    {"connect_wallet_select_network_hint", "Seleccione las redes que desee mostrar dentro de la billetera de software"},
    ...
    {"connect_wallet_upgrade_hint", "Por favor actualice a la última versión para tener acceso a una mayor compatibilidad con carteras de software"},
    ...
    {"connect_zapper_link", "https://keyst.one/t/3rd/zapper"},
    {"connect_zapper_title", "Zapper"},
    {"create_multi_wallet_cancel_desc", "Si cancela, se perderá cualquier información confirmada."},
    {"create_multi_wallet_cancel_title", "¿Cancelar creación de billetera?"},
    ...
    {"create_multi_wallet_co_signers_desc", "Este es el xPub clave de su billetera multi-firma. También puede ver este xPub en la página de inicio de la billetera multi-firma en cualquier momento"},
    {"create_multi_wallet_co_signers_desc_fmt", "Importe el xPub del co-firmante número %d para construir una billetera de multi-firma"},
    ...
    {"create_multi_wallet_name_desc", "Nombre su billetera de múltiples firmas"},
    {"create_multi_wallet_select_format", "Seleccione el formato que le gustaría utilizar para su billetera de varias firmas"},
    ...
    {"derivation_path_eth_standard_desc", "Modo predeterminado, siga BIP44, ampliamente utilizado."},
    ...
    {"derivation_path_select_sol", "Seleccione la ruta de derivación que desee utilizar para Solana"},
    ...
    {"device_setting_wallet_setting_desc", "Nombre / Código de acceso / Frase semilla..."},
    ...
    {"dice_roll_cancel_desc", "Si cancela, cualquier número que haya ingresado se perderá."},
    ...
    {"dice_roll_max_limit_label", "Ha alcanzado los límites máximos"},
    {"dice_rolls_entropy_hint", "Los lanzamientos de dados como entropía"},
    {"enter_passcode", "Ingrese el código de acceso"},
    {"error_box_duplicated_seed_phrase", "Frase Semilla Duplicada"},
    {"error_box_duplicated_seed_phrase_desc", "La frase escrita ya se utiliza en una cuenta de billetera, por favor importe otro conjunto de frase semilla."},
    ...
    {"error_box_invalid_seed_phrase_desc", "La frase de recuperación que ha ingresado es inválida. Por favor, verifique nuevamente su respaldo e intente de nuevo."},
    ...
    {"error_box_mnemonic_not_match_wallet", "Frase semilla incorrecta"},
    {"error_box_mnemonic_not_match_wallet_desc", "La frase semilla es incorrecta. Por favor, verifique e intente de nuevo."},
    ...
    {"fingerprint_add_desc", "Coloque su dedo en el sensor y levántelo una vez que sienta la vibración"},
    {"fingerprint_add_failed", "Fallo al añadir"},
    {"fingerprint_add_failed_duplicate", "Dedo duplicado, por favor use un dedo diferente"},
    {"fingerprint_add_failed_partial", "Detectada huella parcial, por favor inténtelo de nuevo"},
    {"fingerprint_add_failed_use_another", "No se pudo agregar la huella digital, por favor utilice otro dedo e intente de nuevo."},
    {"fingerprint_add_overlaps_too_much", "Área duplicada, por favor ajusta ligeramente la posición de tu dedo."},
    {"fingerprint_add_password", "Ahora necesitamos que ingrese su código de acceso para encriptar y guardar la huella digital"},
    ...
    {"fingerprint_nth_remove_desc", "¿Realmente quiere eliminar el dedo %d?"},
    ...
    {"fingerprint_up_to_3", "Puede agregar hasta 3 huellas dactilares"},
    {"firmware_update_btc_only_button_i_know", "Estoy consciente"},
    {"firmware_update_btc_only_warning_desc", "Está actualizando desde un firmware de múltiples monedas a un firmware solo para BTC. Después de la actualización, #F5870A todas las carteras en este dispositivo #F5870A solo admitirán la moneda BTC#, y este proceso es irreversible. Por favor, confirme que comprende los riesgos involucrados. Si ha descargado el firmware incorrecto, por favor cancele este progreso."},
    {"firmware_update_deny_desc", "Necesita desbloquear tu dispositivo para actualizar la versión del firmware"},
    ...
    {"firmware_update_desc", "Para desbloquear las características más recientes, por favor actualice el firmware a la última versión."},
    {"firmware_update_desc1", "Asegúrese de que su Keystone tenga al menos un 20% de batería restante"},
    {"firmware_update_desc2", "Vaya a la página de actualización de firmware de Keystone utilizando su computadora o teléfono inteligente"},
    {"firmware_update_no_upgradable_firmware_desc", "La versión del firmware de su dispositivo es superior o igual a la que está en su tarjeta microSD"},
    ...
    {"firmware_update_sd_checksum_notice", "Esta es una característica opcional para aumentar aún más la seguridad. Compare el siguiente checksum con el checksum de su paquete de descarga en el sitio web oficial, asegúrese de que sean consistentes."},
    ...
    {"firmware_update_sd_desc2_link", "https://keyst.one/firmware"},
    {"firmware_update_sd_desc3", "Transfiera el archivo de firmware (keystone3.bin) a su Keystone utilizando una tarjeta MicroSD formateada en FAT32"},
    {"firmware_update_sd_desc4", "Toque el botón 'Actualizar' #F5870A que se encuentra debajo para iniciar el proceso"},
    {"firmware_update_sd_dialog_desc", "¿Quiere actualizar el firmware de su dispositivo a la nueva versión?"},
    ...
    {"firmware_update_usb_connect_info_desc", "Una vez conectado, el dispositivo externo obtendrá permiso para transferir datos a su Keystone."},
    {"firmware_update_usb_connect_info_title", "¿Conectarse a este dispositivo?"},
    {"firmware_update_usb_desc3", "Conecte su Keystone a su computadora usando un cable USB-C"},
    {"firmware_update_usb_desc4", "Haga clic en el botón #F5870A Instalar Actualización# en la página web y siga las instrucciones para instalar el firmware más reciente"},
    ...
    {"firmware_update_verify_firmware_qr_link", "KeystoneHQ/keystone3-firmware/docs/verify.md"},
    {"firmware_update_via_sd", "A través de tarjeta MicroSD"},
    {"firmware_update_via_usb", "A través de USB"},
    {"forget_password_cancel", "¿Cancelar restablecimiento de contraseña?"},
    {"forgot_password_reset_passcode_intro_desc", "Verifique la frase semilla asociada a esta billetera para restablecer el código de acceso. Restablecer su contraseña puede borrar los datos de su billetera o billetera multisig"},
    {"forgot_password_reset_passcode_intro_text", "¿Olvidó su código de acceso?"},
    {"forgot_password_reset_passcode_intro_title", "¿Olvidó su código de acceso?"},
    ...
    {"import_wallet_duplicated_share_desc", "Ya ha verificado esta participación, por favor utilice otra participación para continuar."},
    {"import_wallet_invalid_phrase_desc", "La frase que ha escrito es inválida. Por favor, verifique su respaldo e intente de nuevo."},
    {"import_wallet_phrase_clear_btn", "Claro"},
    {"import_wallet_phrase_desc", "Ingrese su frase semilla en los espacios proporcionados a continuación"},
    {"import_wallet_phrase_title", "Importe su frase semilla"},
    {"import_wallet_shamir_backup", "Copia de seguridad Shamir"},
    {"import_wallet_shamir_backup_desc", "Necesitará un par de frases semilla para recuperar su billetera"},
    {"import_wallet_share_success_desc", "Esta parte de su frase semilla coincide con su billetera"},
    {"import_wallet_single_backup_desc", "Recupere su billetera con la frase de recuperación específica. Por favor, complete el proceso de configuración en una ida para evitar cualquier riesgo de seguridad."},
    {"import_wallet_single_phrase", "Frase única secreta"},
    {"import_wallet_single_phrase_desc", "Necesitará una frase de recuperación de 12/18/24 palabras para recuperar su billetera"},
    ...
    {"import_wallet_ssb_desc_fmt", "Ingrese sus #F5870A %d# palabras semilla para Compartir #F5870A %d# en los espacios proporcionados a continuación"},
    {"import_wallet_ssb_incorrect_title", "Duplicar Compartir"},
    {"import_wallet_ssb_notbelong_desc", "El Share que ha introducido no corresponde a esta copia de seguridad. Por favor, verifique nuevamente su copia de seguridad e intente nuevamente."},
    ...
    {"manage_import_wallet_notice_desc1", "Por favor, compare la información de la billetera con la de sus co-firmantes u otras billeteras para asegurar que toda la información sea consistente."},
    {"manage_import_wallet_notice_desc2", "Es crucial hacer una copia de seguridad segura de la configuración de su billetera; la omisión de hacerlo podría resultar en una pérdida irreversible de activos. Si la información ha sido modificada o es inconsistente, esto también podría llevar a una pérdida de activos. Verifique siempre y asegure los detalles de su billetera para prevenir cualquier discrepancia."},
    {"manage_import_wallet_notice_title", "Verifique la información de la billetera"},
    {"manage_import_wallet_passphrase_error_desc", "No se puede importar una billetera multisig en la billetera de frase de contraseña. Por favor, salga del modo de frase de contraseña y vuelva a intentarlo."},
    ...
    {"manage_multi_wallet_export_attention_desc1", "Cuando exporte o vuelva a importar su billetera de firma múltiple, asegúrese de que todos los datos sean consistentes para usted y sus co-firmantes."},
    ...
    {"manage_wallet_confirm_address_desc", "Verifique que la dirección de Recibir coincida en todos los dispositivos o billeteras de software de todas las partes"},
    ...
    {"multi_wallet_no_file_notice", "Por favor, asegúrese de que el archivo esté nombrado con letras en inglés y ubicado en la ruta principal."},
    {"multi_wallet_no_psbt_file", "Sin archivos de billetera sin archivos PSBT"},
    {"multisig_connect_wallet_notice", "Está usando una billetera Multisig"},
    {"multisig_decoding_qr_link", "https://keyst.one/t/3rd/Multisig/import"},
    ...
    {"multisig_export_to_sdcard_failed_desc", "Algo salió mal. Por favor, inténtelo de nuevo."},
    {"multisig_export_to_sdcard_success", "Exportado exitosamente"},
    {"multisig_export_to_sdcard_success_desc", "Su monedero multisig ha sido exportado exitosamente a la tarjeta MicroSD"},
    {"multisig_import_success_hint", "Invite a los co-firmantes a escanear el código QR para importar una billetera multisig o escanee este código QR con una billetera de software para completar la conexión"},
    {"multisig_import_wallet_exist", "La billetera ya existe"},
    {"multisig_import_wallet_exist_desc", "La billetera multisig que seleccionó ya existe en el dispositivo actual, por favor importe otra billetera."},
    {"multisig_import_wallet_invalid", "Configuración de billetera inválida"},
    {"multisig_import_wallet_invalid_desc", "La configuración actual de la billetera es incorrecta. Por favor, revise cuidadosamente si la información del MFP, Path y xPub es precisa."},
    ...
    {"multisig_signature_hint_1", "Por favor, pida a los co-firmantes que escaneen el código QR y firmen."},
    ...
    {"passphrase_add_password", "Ahora es necesario que ingrese su código de acceso para configurar la billetera con frase de contraseña"},
    ...
    {"passphrase_learn_more_desc1", "Una frase de contraseña ofrece un nivel adicional de seguridad a su frase semilla actual"},
    {"passphrase_learn_more_desc2", "Cada frase de contraseña única genera una billetera diferente"},
    {"passphrase_learn_more_desc3", "Para recuperar su billetera, se requieren tanto la clave de acceso como la frase de recuperación."},
    {"passphrase_learn_more_desc4", "Olvidar la frase de contraseña puede resultar en la pérdida de acceso a sus activos digitales"},
    ...
    {"password_error_fingerprint_attempts_exceed", "Demasiados intentos. Por favor, introduce su código de acceso para desbloquear el dispositivo."},
    ...
    {"pin_code", "Código PIN"},
    {"pin_label", "PIN"},
    {"please_enter_passcode", "Por favor ingrese la frase contraseña"},
    {"power_off", "Apagar"},
    {"power_requirements_hintbox_cancel", "OK"},
    ...
    {"power_requirements_hintbox_title", "Requerimientos de carga"},
    ...
    {"purpose_desc", "Cree una nueva billetera o importe una billetera existente con la frase de recuperación"},
    {"purpose_import_wallet", "Importar billetera"},
    {"purpose_new_wallet", "Crear una billetera"},
    ...
    {"repeat_passcode_desc", "Confirma dos veces el código PIN que ha ingresado"},
    ...
    {"rust_error_bitcoin_not_my_multisig_wallet_desc", "Esta configuración de billetera multisig no pertenece a la billetera actual. Por favor, verifique la información de la configuración de la billetera multisig."},
    ...
    {"scan_qr_code_error_invalid_qrcode_desc", "Los datos del código QR no son reconocidos. Por favor, inténtelo de nuevo."},
    ...
    {"scan_qr_code_invalid_b_desc", "La transacción no pertenece a la billetera actual. Por favor, asegúrese de utilizar la billetera correcta para autorizar la transacción."},
    ...
    {"scan_qr_code_sign_unsigned_content_fingerprint_failed_desc", "La verificación falló. ¡Por favor inténtelo de nuevo!"},
    ...
    {"scan_qr_code_sign_unsigned_content_frame", "Deslice para confirmar"},
    {"scan_qr_code_signing_desc", "Firma"},
    {"sdcard_format_confirm", "Formato"},
    {"sdcard_format_desc", "Su tarjeta MicroSD se formateará a FAT32, borrando todos los archivos. Por favor, realice una copia de seguridad de los archivos esenciales antes de formatear."},
    ...
    {"seed_check_passphrase_notice", "Actualmente está utilizando una billetera protegida con frase de contraseña. Antes de continuar con el proceso de verificación de la frase semilla, reinicie su dispositivo sin ingresar la frase de contraseña."},
    {"seed_check_passphrase_title", "Desactivar billetera de contraseña"},
    {"seed_check_share_phrase", "Copia de seguridad de Shamir"},
    {"seed_check_share_phrase_title", "Ingrese su frase semilla para verificar si coincide con su billetera actual"},
    {"seed_check_single_phrase", "Frase semilla estándar"},
    {"seed_check_single_phrase_title", "Ingrese su semilla"},
    {"seed_check_verify_match_desc", "Su semilla ha sido validada y verificada correctamente"},
    ...
    {"shamir_phrase_backup_desc", "Escriba su frase de Share #F5870A 1# y guárdela correctamente"},
    {"shamir_phrase_cancel_create_desc", "Si cancela, cualquier acción confirmada se perderá."},
    {"shamir_phrase_cancel_create_title", "¿Desea abandonar la configuración de la billetera?"},
    {"shamir_phrase_confirm_desc", "Seleccione las palabras a continuación en el orden correcto de su frase Compartir 1 para validar su frase de recuperación"},
    {"shamir_phrase_custodian_desc", "Por favor, confirme que es el custodio de la acción #F5870A 1#."},
    {"shamir_phrase_custodian_title", "Compartir Compartir #F5870A 1#"},
    {"shamir_phrase_number", "Número de acciones"},
    {"shamir_phrase_share_backup_notice_fmt", "Escriba su frase Share #F5870A %d# y guárdela adecuadamente"},
    {"shamir_phrase_share_confirm_notice_fmt", "Seleccione las palabras a continuación en el orden correcto de su frase de inicio #F5870A %d# para validar su frase inicial"},
    {"shamir_phrase_share_notice_fmt", "Por favor, confirme que es el custodio de la Acción #F5870A %d#."},
    ...
    {"single_backup_namewallet_desc", "Nombrar su billetera y seleccionar un ícono para hacerla fácilmente distinguible"},
    {"single_backup_namewallet_previnput", "Nombre de la billetera"},
    {"single_backup_namewallet_previnput_2", "Elige un ícono para su billetera"},
    {"single_backup_namewallet_title", "Nombre su billetera"},
    {"single_backup_notice_desc1", "Nunca compartas su frase de recuperación con nadie más, ya que otorga acceso a sus activos."},
    {"single_backup_notice_desc2", "Asegúrese de que no haya espectadores o cámaras al grabar su frase de recuperación"},
    {"single_backup_notice_title", "Verifique su entorno"},
    {"single_backup_phrase_regenerate_desc", "¿Regenerar un nuevo conjunto de Frase Semilla?"},
    {"single_backup_repeatpass_desc", "Doble confirma la contraseña que ha ingresado"},
    {"single_backup_repeatpass_title", "Vuelva a introducir la contraseña"},
    {"single_backup_repeatpin_error", "El código PIN no coincide"},
    {"single_backup_setpass_desc", "La contraseña se utilizará para desbloquear su billetera y autorizar transacciones"},
    {"single_backup_setpass_error_2", "La contraseña no coincide"},
    {"single_backup_setpass_title", "Establecer contraseña"},
    {"single_backup_setpin_desc", "El código PIN se utilizará para desbloquear su billetera y autorizar transacciones"},
    ...
    {"single_backup_shamir_desc", "Un procedimiento avanzado para almacenar de forma segura su frase semilla"},
    {"single_backup_shamir_title", "Copia de seguridad de Shamir"},
    {"single_backup_single_phrase_desc", "12 o 24 frase semilla de respaldo. Método más comúnmente utilizado"},
    {"single_backup_single_phrase_title", "Frase semilla estándar"},
    {"single_phrase_confirm_desc", "Seleccione las palabras a continuación en el orden correcto para validar su frase semilla"},
    {"single_phrase_confirm_title", "Confirma su contraseña"},
    {"single_phrase_desc", "Escribe su frase de recuperación y guárdala en un lugar seguro"},
    ...
    {"single_phrase_title", "Guarda una copia de seguridad de su semilla"},
    ...
    {"system_settings_wipe_device_wipe_desc", "Al continuar, todos los datos en este dispositivo, incluyendo todas sus carteras, serán eliminados de forma permanente."},
    ...
    {"transaction_parse_scan_by_software", "Escanea el código QR con su billetera de software"},
    ...
    {"unlock_device_time_limited_error_max_desc", "Por favor, desbloquea su dispositivo en #F55831 1# minuto."},
    {"unlock_device_time_limited_error_max_desc_fmt", "Por favor, desbloquea su dispositivo en #F55831 %d# minutos."},
    {"unlock_device_time_limited_error_max_title", "Dispositivo no disponible"},
    {"unlock_device_time_limited_error_max_warning_fmt", "Por favor, desbloquea su dispositivo en #F55831 %d# minutos. Un intento incorrecto más, su dispositivo se bloqueará."},
    ...
    {"usb_transport_connect_rabby", "Rabby Wallet quiere conectar su Keystone mediante USB"},
    {"usb_transport_connect_wallet", "Tu billetera de software quiere conectarse a su dispositivo a través de USB"},
    ...
    {"usb_transport_sign_completed_subtitle", "Ver detalles de la transacción en su billetera de software"},
    ...
    {"verify_cont2", "Escanea el código QR que se muestra en el sitio web para obtener su código de verificación del dispositivo"},
    {"verify_cont3", "Ingrese el código en el sitio web para verificar cualquier posible manipulación de su dispositivo"},
    {"verify_desc", "Este proceso asegure la integridad de su dispositivo Keystone y el firmware"},
    ...
    {"verify_title", "Verifique su dispositivo"},
    {"verify_title_text", "Verifique su dispositivo"},
    ...
    {"wallet_setting_add_wallet_notice", "La billetera de hardware es solo para uso personal. No la compartas para evitar riesgos en sus activos"},
    ...
    {"wallet_setting_stop_add_fingerprint_desc", "No se guardó la huella dactilar. Al cancelar, tendrás que volver a ingresar su huella dactilar."},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"rust_error_bitcoin_no_my_inputs", "不一致な取引"},
    {"rust_error_bitcoin_no_my_inputs_desc", "現在のウォレットに関連する取引ではありません.取引情報を確認してください."},
