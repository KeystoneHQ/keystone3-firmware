...
typedef enum {
    ...
    PRS_SET_PUBKEY_ERROR,
    PRS_SET_PUBKEY_REJECTED,
    PRS_SET_PUBKEY_BUSY,
    PRS_SET_PUBKEY_INVALID_PARAMS,
    PRS_SET_PUBKEY_VERIFY_FAILED,
    PRS_SET_PUBKEY_VERIFY_SUCCESS,
    PRS_SET_PUBKEY_SET_SUCCESS,
    RPS_SET_PUBKEY_SET_FAILED,
