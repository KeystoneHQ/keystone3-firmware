...
#define FINGER_PRINT_EVENT_UPDATE       0x8
#define FINGER_PRINT_ALL_EVENT          (FINGER_PRINT_EVENT_UART_RECV | FINGER_PRINT_EVENT_RESTART | FINGER_PRINT_EVENT_LOW_POWER | FINGER_PRINT_EVENT_UPDATE)
